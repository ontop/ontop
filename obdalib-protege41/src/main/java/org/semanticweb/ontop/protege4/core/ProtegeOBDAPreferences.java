...
/**
 * Formerly known as OBDAPreferences. Renamed for avoiding confusion with OBDAProperties.
 * Old class.
 *
 * TODO: see if it worth being synchronized by new-style OBDAProperties.
 */
public class ProtegeOBDAPreferences extends Properties implements Disposable{
