...
public class DataTypeComboBox extends JComboBox {
	...
	private static Predicate[] getQuestDataTypePredicates() {
		int length = OBDADataFactoryImpl.QUEST_DATATYPE_PREDICATES.length + 1;
		Predicate[] dataTypes = new Predicate[length];
		dataTypes[0] = null;
		System.arraycopy(OBDADataFactoryImpl.QUEST_DATATYPE_PREDICATES, 0, dataTypes, 1, OBDADataFactoryImpl.QUEST_DATATYPE_PREDICATES.length);
		return dataTypes;
	}
