...
public class H2SelectFromWhereSerializer extends DefaultSelectFromWhereSerializer implements SelectFromWhereSerializer {
    ...
    protected class DefaultRelationVisitingSerializer extends DefaultSelectFromWhereSerializer.DefaultRelationVisitingSerializer
            implements SQLRelationVisitor<QuerySerialization> {
