...
public class SerializedMetadataProviderImpl implements SerializedMetadataProvider {
    ...
    private final Map<RelationID, NamedRelationDefinition> relationMap;
     ...
     */
    protected static ImmutableMap<RelationID, NamedRelationDefinition> extractRelationDefinitions(JSONRelation jsonMetadata,
                                                                                                     QuotedIDFactory quotedIDFactory,
                                                                                                     TypeFactory typeFactory) throws MetadataExtractionException {

        ImmutableMap<RelationID, NamedRelationDefinition> relationMap = jsonMetadata.getRelations().stream()
     ...
     */
    protected static NamedRelationDefinition extractRelationDefinition(Relation parsedRelation, QuotedIDFactory quotedIDFactory, TypeFactory typeFactory) {
        ...
        NamedRelationDefinition relationDefinition = builder.createDatabaseRelation(ImmutableList.of(id), attributeListBuilder);
     ...
     */
    protected static void insertUniqueConstraints(Relation parsedRelation, NamedRelationDefinition relationDefinition, QuotedIDFactory quotedIDFactory) {
     ...
     * Insert the FKs
     */
    private static void insertForeignKeys(JSONRelation jsonMetadata, ImmutableMap<RelationID, NamedRelationDefinition> relationMap, QuotedIDFactory quotedIDFactory) throws MetadataExtractionException {
