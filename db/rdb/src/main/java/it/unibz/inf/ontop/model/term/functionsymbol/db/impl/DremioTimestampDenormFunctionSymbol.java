...
public class DremioTimestampDenormFunctionSymbol extends AbstractDBTypeConversionFunctionSymbolImpl{

    private final DBTermType dbStringType;
    protected static final String TEMPLATE = "CAST (%s AS TIMESTAMP)";

    protected DremioTimestampDenormFunctionSymbol(DBTermType dbTimestampType,DBTermType dbStringType) {
