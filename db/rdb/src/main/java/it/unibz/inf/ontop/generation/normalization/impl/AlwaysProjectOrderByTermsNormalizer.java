...
public class AlwaysProjectOrderByTermsNormalizer extends DefaultDelegatingIQTreeVariableGeneratorTransformer implements DialectExtraNormalizer {

    @Inject
    protected AlwaysProjectOrderByTermsNormalizer(CoreSingletons coreSingletons) {
        super(IQTreeVariableGeneratorTransformer.of(
                vg -> new ProjectOrderByTermsTransformer(vg, false, coreSingletons)));
    }
}
