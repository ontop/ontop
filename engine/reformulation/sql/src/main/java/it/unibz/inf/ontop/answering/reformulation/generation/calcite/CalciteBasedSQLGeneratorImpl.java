...
public class CalciteBasedSQLGeneratorImpl implements CalciteBasedSQLGenerator {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(CalciteBasedSQLGeneratorImpl.class);
    ...
    @AssistedInject
    private CalciteBasedSQLGeneratorImpl(@Assisted DBMetadata metadata,
...
//        ds.setPassword(settings.getJdbcPassword());
    ...
    @Override
    public CalciteBasedSQLGenerator clone(DBMetadata dbMetadata) {
