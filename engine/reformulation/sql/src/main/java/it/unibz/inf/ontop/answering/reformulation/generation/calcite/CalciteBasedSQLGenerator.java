...
public class CalciteBasedSQLGenerator implements NativeQueryGenerator {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(CalciteBasedSQLGenerator.class);
    ...
    private final TypeFactory typeFact;
    ...
    @AssistedInject
    private CalciteBasedSQLGenerator(@Assisted DBMetadata metadata,
//                                     @Nullable IRIDictionary iriDictionary,
                                     OntopSQLCredentialSettings coreSettings,
                                     JdbcTypeMapper jdbcTypeMapper, PullOutVariableOptimizer pullOutVariableOptimizer, TermFactory termFactory, TypeFactory typeFact, SubstitutionFactory substitutionFactory) {
...
//        ds.setPassword(settings.getJdbcPassword());
        ...
        Map<String, Object> operand = ImmutableMap.<String, Object>builder()
                ...
                .put("jdbcDriver", settings.getJdbcDriver())
    ...
    public class NodeProcessor implements QueryNodeVisitor {
