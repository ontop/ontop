...
public class RDF4JInputQueryTranslatorImpl implements RDF4JInputQueryTranslator {
    ...
    public IQ translate(ParsedQuery pq) {
        ...
        ImmutableList<Variable> projectedVars = pq.getTupleExpr().getBindingNames().stream()
                ...
                // filter out the extra binding generated by the rdf4j API for constants
...
//    private ImmutableList<IQTree> getBindingSetCn(BindingSetAssignment node, ImmutableSet<Variable> valueVars) {
//        // Assumption: the binding sets have disjoint domains
//        return StreamSupport.stream(node.getBindingSets().spliterator(), false)
//                .map(b -> getBindingSetCn(
//                        b,
...
//    }
    ...
    private TranslationResult translateOptional(LeftJoin leftJoin, VariableGenerator variableGenerator) throws OntopInvalidInputQueryException, OntopUnsupportedInputQueryException {
        ...
        InjectiveVar2VarSubstitution leftRenamingSubstitution = generateVariableSubstitution(toCoalesce,
                variableGenerator);
        InjectiveVar2VarSubstitution rightRenamingSubstitution = generateVariableSubstitution(toRenameRight,
                variableGenerator);
