...
public class RDF4JInputQueryTranslatorImpl implements RDF4JInputQueryTranslator {
    ...
    private TranslationResult translateAggregate(Group groupNode, VariableGenerator variableGenerator) throws OntopInvalidInputQueryException, OntopUnsupportedInputQueryException {
        TranslationResult child = translate(groupNode.getArg(), variableGenerator);
