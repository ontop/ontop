...
class RDF4JConstructQueryImpl extends RDF4JInputQueryImpl<SimpleGraphResultSet> implements RDF4JConstructQuery {
    ...
    RDF4JConstructQueryImpl(String queryString, ParsedQuery parsedQuery, BindingSet bindings) {
        this(ConstructQuerySplit.split(parsedQuery), queryString, bindings);
    }

    private RDF4JConstructQueryImpl(ConstructQuerySplit split, String queryString,
                                    BindingSet bindings) {
        this(split.constructTemplate, split.selectParsedQuery, queryString, bindings);
    }
    ...
    private static class ConstructQuerySplit {
        public ConstructTemplate constructTemplate;
        public ParsedTupleQuery selectParsedQuery;

        private ConstructQuerySplit(ConstructTemplate constructTemplate, ParsedTupleQuery selectQuery) {
            this.constructTemplate = constructTemplate;
            this.selectParsedQuery = selectQuery;
        }


        public static ConstructQuerySplit split(ParsedQuery parsedQuery) {
