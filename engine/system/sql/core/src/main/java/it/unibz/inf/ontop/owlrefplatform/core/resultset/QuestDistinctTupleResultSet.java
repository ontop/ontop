...
public class QuestDistinctTupleResultSet implements TupleResultSet {
    ...
    public QuestDistinctTupleResultSet(ResultSet set, List<String> signature,
                                       DBMetadata dbMetadata,
                                       Optional<IRIDictionary> iriDictionary) {

        questTupleResultSet = new QuestTupleResultSet(set, signature, dbMetadata, iriDictionary);
