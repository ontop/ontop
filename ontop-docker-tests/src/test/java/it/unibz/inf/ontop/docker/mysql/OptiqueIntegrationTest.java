...
public class OptiqueIntegrationTest extends AbstractVirtualSesameTest {
	private static final String owlfile = "src/test/resources/mysql/example/npd-v2-ql_a.owl";
	private static final String mappingfile = "src/test/resources/mysql/example/npd-v2-ql_a.ttl";
	private static final String propertyfile = "src/test/resources/mysql/example/npd-v2-ql_a.properties";
