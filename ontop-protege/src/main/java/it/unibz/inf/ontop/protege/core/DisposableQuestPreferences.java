...
public class DisposableQuestPreferences extends QuestPreferences implements Disposable {
	...
	public DisposableQuestPreferences() {
		super();
	}

	public DisposableQuestPreferences(Properties p) {
		super(p);
	}
	...
	public DisposableQuestPreferences newProperties(Object key, Object value) {
		Properties newProperties = copyProperties();
		newProperties.put(key, value);
		return new DisposableQuestPreferences(newProperties);
	}
}
