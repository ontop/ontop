package it.unibz.krdb.ontop.api.io;
...
public class ModelIOManagerUsingOwlTest extends TestCase {
    ...
    private void loadOntologyToModel(OBDAModel model) throws OWLOntologyCreationException {
        ...
        File file = new File("src/test/java/it/unibz/krdb/ontop/api/io/School.owl");
    ...
    public void testLoadWithBlankMappingId() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile5.ontop");
        } catch (IOException e) {
            assertFalse(true);
    ...
    public void testLoadWithBlankTargetQuery() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile6.ontop");
        } catch (IOException e) {
            assertFalse(true);
        } catch (InvalidPredicateDeclarationException e) {
            assertFalse(true);
    ...
    public void testLoadWithBlankSourceQuery() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile7.ontop");
        } catch (IOException e) {
            assertFalse(true);
        } catch (InvalidPredicateDeclarationException e) {
            assertFalse(true);
    ...
    public void testLoadWithBadTargetQuery() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile8.ontop");
        } catch (IOException e) {
        	assertTrue(true);
        } catch (InvalidPredicateDeclarationException e) {
            assertFalse(true);
    ...
    public void testLoadWithPredicateDeclarations() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile9.ontop");
        } catch (IOException e) {
        	assertTrue(true);
        } catch (InvalidPredicateDeclarationException e) {
            assertFalse(true);
    ...
    public void testLoadWithAllMistakes() {
        resetCurrentModel();
        try {
            loadObdaFile("src/test/resources/it/unibz/krdb/ontop/api/io/SchoolBadFile10.ontop");
        } catch (IOException e) {
            assertFalse(true);
        } catch (InvalidPredicateDeclarationException e) {
            assertFalse(true);
    ...
    private void saveRegularFile() throws IOException {
        ...
        ioManager.save("src/test/java/it/unibz/krdb/ontop/api/io/SchoolRegularFile.ontop");
    }
    ...
    private void saveFileWithMultipleDataSources() throws IOException {
        ...
        // Save the model
        ioManager = new ModelIOManager(model);
        ioManager.save("src/test/java/it/unibz/krdb/ontop/api/io/SchoolMultipleDataSources.ontop");
    }
    ...
    private void loadRegularFile() throws IOException, InvalidPredicateDeclarationException, InvalidMappingException {
        ioManager = new ModelIOManager(model);
        ioManager.load("src/test/java/it/unibz/krdb/ontop/api/io/SchoolRegularFile.ontop");
    ...
    private void loadFileWithMultipleDataSources() throws IOException, InvalidPredicateDeclarationException, InvalidMappingException {
        ioManager = new ModelIOManager(model);
        ioManager.load("src/test/java/it/unibz/krdb/ontop/api/io/SchoolMultipleDataSources.ontop");
