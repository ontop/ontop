...
public class OWLTypeMapper {
	...
	public static Predicate.COL_TYPE getType(OWLDatatype datatype) throws OWLAPI3TranslatorBase.TranslationException {
		if (datatype == null) 
			return COL_TYPE.LITERAL;
		
		COL_TYPE type = OWLtoCOLTYPE.get(datatype.getBuiltInDatatype());
		if (type == null)
			throw new OWLAPI3TranslatorBase.TranslationException("Unsupported data range: " + datatype);
		return type;
	}
