		...
		<form action="create" method="post">
			<table class="dataentry">
				<tbody>
					...
					<tr>
						<td> <xsl:value-of select="$ontop-inmemory-warning.label" /> </td>
					</tr>					
                                        <tr>
						<th>
						...
						<td>
							<input type="text" id="id"
								name="Repository ID" size="16" value="ontop-inmemory" />
						</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="owlfile" name="Owl File" size="48" value="" />
						</td>
						<td>
							<xsl:value-of select="$ontop-owlfilecommentinmem.label" />
					...
					<tr>
						...
						<td>
							...
							<input type="radio" id="existential"
								name="Existential reasoning" size="48" value="false" checked="true" />
