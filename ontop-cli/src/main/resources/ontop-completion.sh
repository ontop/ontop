...
# Or, copy it somewhere (e.g. ~/.ontop-completion.sh) and put the following in your .bash_profile::
#
# source ~/.ontop-completion.sh

# Generated by org.semanticweb.ontop.cli.OntopBashCompletionGenerator
...
function _complete_ontop() {
  ...
  COMMANDS="help materialize query bootstrap"
