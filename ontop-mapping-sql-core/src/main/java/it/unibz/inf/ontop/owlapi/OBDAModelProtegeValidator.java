...
import it.unibz.inf.ontop.model.OBDAModelValidator;
...
public class OBDAModelProtegeValidator implements OBDAModelValidator{

	public boolean validate(OBDAModel obdaModel, ImmutableOntologyVocabulary vocabulary) throws Exception {
