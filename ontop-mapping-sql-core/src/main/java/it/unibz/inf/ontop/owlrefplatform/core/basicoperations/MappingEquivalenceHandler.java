...
public class MappingEquivalenceHandler extends EquivalenceHandler {

    public MappingEquivalenceHandler(TBoxReasoner reasoner, ImmutableOntologyVocabulary voc) {
        super(reasoner, voc);
    }
