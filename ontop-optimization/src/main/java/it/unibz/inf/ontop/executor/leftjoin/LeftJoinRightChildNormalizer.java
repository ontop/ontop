 ...
 */
@Singleton
public class LeftJoinRightChildNormalizer {

    @Inject
    private LeftJoinRightChildNormalizer() {
    }
    ...
    public LeftJoinRightChildNormalization compare(DataNode leftDataNode, DataNode rightDataNode, DBMetadata dbMetadata,
        ...
        if (!(optionalLeftRelation.isPresent() && optionalRightRelation.isPresent())) {
            ...
            return new LeftJoinRightChildNormalization(false);
        }
        ...
        if (!conflictingRightArgumentIndexes.isEmpty()) {
            ...
            return new LeftJoinRightChildNormalization(newRightDataNode, newExpression);
        }
        else {
            return new LeftJoinRightChildNormalization(true);
        }
    }
     ...
     */
    public static class LeftJoinRightChildNormalization {
        ...
        private LeftJoinRightChildNormalization(DataNode newRightDataNode, ImmutableExpression expression) {
            this.newRightDataNode = newRightDataNode;
            this.expression = expression;
            this.isMatchingAConstraint = true;
        }

        private LeftJoinRightChildNormalization(boolean isMatchingAConstraint) {
