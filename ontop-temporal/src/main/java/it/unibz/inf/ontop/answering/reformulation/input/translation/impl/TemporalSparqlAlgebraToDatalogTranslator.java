...
public class TemporalSparqlAlgebraToDatalogTranslator {
    private static final Logger log = LoggerFactory.getLogger(TemporalSparqlAlgebraToDatalogTranslator.class);
     ...
     *
     */
    TemporalSparqlAlgebraToDatalogTranslator(@Nonnull UriTemplateMatcher uriTemplateMatcher,
    ...
    public InternalSparqlQuery translate(ParsedQuery pq) throws OntopUnsupportedInputQueryException, OntopInvalidInputQueryException {
        ...
        if (predicateIdx != 0 || !program.getRules().isEmpty())
            throw new IllegalStateException("translate can only be called once.");
