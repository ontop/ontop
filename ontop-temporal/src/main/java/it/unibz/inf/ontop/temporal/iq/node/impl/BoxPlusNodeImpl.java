...
public class BoxPlusNodeImpl extends TemporalOperatorWithRangeImpl implements BoxPlusNode{
    ...
    public String toString() {
        return BOXPLUS_NODE_STR + getRange();
    }
    ...
    @Override
    public BoxPlusNodeImpl acceptNodeTransformer(HomogeneousQueryNodeTransformer transformer) throws QueryNodeTransformationException {
        return this;
    }
    ...
    public IQTree acceptTransformer(IQTree tree, IQTransformer transformer, IQTree child) {
        if (transformer instanceof TemporalIQTransformer){
            return ((TemporalIQTransformer) transformer).transformBoxPlus(tree, this, child);
        } else {
