...
import static it.unibz.inf.ontop.answering.reformulation.generation.utils.COL_TYPE.STRING;

public class TemporalOneShotSQLGeneratorEngine {
    ...
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(TemporalOneShotSQLGeneratorEngine.class);
    ...
    TemporalOneShotSQLGeneratorEngine(DBMetadata metadata,
     ...
     */
    private TemporalOneShotSQLGeneratorEngine(RDBMetadata metadata, SQLDialectAdapter sqlAdapter,
     ...
     */
    @Override
    public TemporalOneShotSQLGeneratorEngine clone() {
        return new TemporalOneShotSQLGeneratorEngine(metadata, sqladapter,
