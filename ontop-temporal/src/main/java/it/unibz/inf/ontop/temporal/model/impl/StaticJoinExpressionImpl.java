...
import it.unibz.inf.ontop.temporal.model.NAryStaticExpression;
...
public class StaticJoinExpressionImpl implements StaticJoinExpression, NAryStaticExpression {
    ...
    public String toString() {
        return "StaticJoinExpressionImpl{" +
                "operands=" + operands +
                '}';
    }
