...
public class TemporalRangeRelNode implements RelNode {

    private final RexNode beginInc;
    private final RexNode begin;
    private final RexNode end;
    private final RexNode endInc;

    public TemporalRangeRelNode(RexNode beginInc, RexNode begin, RexNode end, RexNode endInc) {
