...
public class TemporalJoinRelNode implements RelNode {

    private final List<RelNode> operands;

    public TemporalJoinRelNode(List<RelNode> operands) {

        this.operands = operands;
    }

    public TemporalJoinRelNode(RelNode... operands) {
