...
public class RDB2RDFMaterializerTest {
    /**
    ...
    static final Logger logger = LoggerFactory.getLogger(RDB2RDFMaterializerTest.class);

    public RDB2RDFMaterializerTest(String name, String sqlFile, String mappingFile, String outputFile) {
        this.name = name;
    ...
    private void runTestWithoutIgnores() throws Exception {
        ...
        try (RepositoryConnection con = dataRep.getConnection()) {
            ...
            MaterializationGraphQuery gquery = materializer.materialize();
