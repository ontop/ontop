...
GRANT SELECT ON "Writer" TO "IAM:ontop-athena";
GRANT SELECT ON "Book" TO "IAM:ontop-athena";
GRANT SELECT ON "BookWriter" TO "IAM:ontop-athena";
GRANT SELECT ON "Edition" TO "IAM:ontop-athena";