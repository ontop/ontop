...
CREATE TABLE course (
	...
	duration decimal(38,4) NOT NULL
);
...
GRANT SELECT ON course TO "IAM:ontop-athena";
GRANT SELECT ON professors TO "IAM:ontop-athena";
GRANT SELECT ON teaching TO "IAM:ontop-athena";