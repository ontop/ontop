...
public class LeftJoinProfPrestoTest extends AbstractLeftJoinProfTest {

    private static final String PROPERTIES_FILE = "/prof/presto/prof-presto.properties";
    private static final String PRESTO_OBDA_FILE = "/prof/presto/prof-presto.obda";

    @BeforeAll
    public static void before() throws IOException, SQLException {
        initOBDA(PRESTO_OBDA_FILE, OWL_FILE, PROPERTIES_FILE);
    }
    ...
    @Override
    @Test
    public void testAggregationMappingProfStudentCountProperty() { super.testAggregationMappingProfStudentCountProperty(); }
}
