...
public class WebSocketFunctionsTDengineTest extends AbstractFunctionsTDEngineTest {
    protected static final String PROPERTIES_FILE = "/tdengine/functions-ws.properties";
    @BeforeAll
