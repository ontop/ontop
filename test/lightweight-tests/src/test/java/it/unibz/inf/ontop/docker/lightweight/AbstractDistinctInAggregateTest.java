...
public abstract class AbstractDistinctInAggregateTest extends AbstractVirtualModeTest {
    ...
    protected static final String owlFile = "/university/university.ttl";
    protected static final String obdaFile = "/university/university.obda";
    ...
    protected static final String groupConcatDistinctQueryFile = "/distinctInAggregates/groupConcatDistinct.rq";
        //"/distinctInAggregates/groupConcatDistinct.rq";
    ...
    protected static OntopOWLEngine createReasoner(String owlFile, String obdaFile, String propertiesFile) throws OWLOntologyCreationException {
        owlFile = AbstractDistinctInAggregateTest.class.getResource(owlFile).toString();
        obdaFile =  AbstractDistinctInAggregateTest.class.getResource(obdaFile).toString();
        propertiesFile =  AbstractDistinctInAggregateTest.class.getResource(propertiesFile).toString();
