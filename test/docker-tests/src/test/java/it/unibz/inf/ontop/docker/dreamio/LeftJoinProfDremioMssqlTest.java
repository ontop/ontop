...
public class LeftJoinProfDremioMssqlTest extends AbstractLeftJoinProfTest {

    private static final String OWL_FILE = "/redundant_join/redundant_join_fk_test.owl";
    private static final String OBDA_FILE = "/redundant_join/dremio/redundant_join_fk_test_mssql.obda";
    private static final String PROPERTY_FILE = "/dremio/redundant_join_fk_test.properties";
