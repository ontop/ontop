...
public class SesameMaterializerCmdTest extends TestCase {
	...
	public void testModelN3() throws Exception {
		...
		// output
		File out = new File("src/test/resources/mysql/materializer/materializeN3.N3");
	...
	public void testModelTurtle() throws Exception {
		// output
		File out = new File("src/test/resources/mysql/materializer/materializeTurtle.ttl");
		String outfile = out.getAbsolutePath();
		System.out.println(outfile);
	...
	public void testModelRdfXml() throws Exception {
		// output
		File out = new File("src/test/resources/mysql/materializer/materializeRdf.owl");
		String outfile = out.getAbsolutePath();
		System.out.println(outfile);
	...
	public void testOWLApiModel() throws Exception {
		File out = new File("src/test/resources/mysql/materializer/materializeOWL.owl");
		String outfile = out.getAbsolutePath();
		System.out.println(outfile);
	...
	public void testOWLApiModeOnto() throws Exception {
		File out = new File("src/test/resources/mysql/materializer/materializeOWL2.owl");
		String outfile = out.getAbsolutePath();
		System.out.println(outfile);
	...
	private static OntopSQLOWLAPIConfiguration.Builder<? extends OntopSQLOWLAPIConfiguration.Builder> createConfigurationBuilder() {
		...
		String obdaFileName =  SesameMaterializerCmdTest.class.getResource("/mysql/materializer/MaterializeTest.obda").toString();
		String propertyFileName =  SesameMaterializerCmdTest.class.getResource("/mysql/materializer/MaterializeTest.properties").toString();
