...
public class DockerMssqlTestSuite extends QuestVirtualScenarioParent {

	public DockerMssqlTestSuite(String testURI, String name, String queryFileURL, String resultFileURL,
	...
	public static Test suite() throws Exception {
		return ScenarioManifestTestUtils.suite(new Factory() {
			...
			public QuestVirtualScenarioParent createQuestScenarioTest(String testURI, String name, String queryFileURL, 
				...
				return new DockerMssqlTestSuite(testURI, name, queryFileURL, resultFileURL, owlFileURL,
						obdaFileURL, parameterFileURL);
			}
			@Override
			public String getMainManifestFile() {
				return "/testcases-docker/manifest-scenario-mssql.ttl";
			}
		});
	}
}
