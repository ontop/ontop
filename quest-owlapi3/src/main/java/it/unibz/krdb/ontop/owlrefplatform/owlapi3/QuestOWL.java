...
public class QuestOWL extends OWLReasonerBase implements AutoCloseable {
	...
	/**
	 * extract version from {@link it.unibz.krdb.ontop.utils.VersionInfo}, which is from the file {@code version.properties}
	 */
