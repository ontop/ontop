...
public class TripleRefPredicateImpl extends RDFAtomPredicateImpl implements TripleRefPredicate {

    private static final int TRIPLE_REFERENCE_INDEX = 3;

    protected TripleRefPredicateImpl(ImmutableList<TermType> expectedBaseTypes,
                                     RDFTermTypeConstant iriType, RDF rdfFactory) {
        super("tripleRef", expectedBaseTypes, 0, 1, 2, iriType, rdfFactory);
    }
