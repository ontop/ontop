...
public class AbstractStatisticalSPARQLAggregationFunctionSymbolImpl extends UnaryNumericSPARQLAggregationFunctionSymbolImpl {

    private final String defaultAggVarName;
    private final boolean isPop;
    private final GetDBFunctionSymbolFunction getDBFunctionSymbolFunction;

    protected AbstractStatisticalSPARQLAggregationFunctionSymbolImpl(String defaultAggVarName, String functionName,
                                                                     String officialName, RDFTermType rootRdfTermType, boolean isDistinct, boolean isPop,
                                                                     GetDBFunctionSymbolFunction getDBFunctionSymbolFunction) {
        this(defaultAggVarName, functionName, officialName, rootRdfTermType, isDistinct, isPop, true, getDBFunctionSymbolFunction);
    }

    protected AbstractStatisticalSPARQLAggregationFunctionSymbolImpl(String defaultAggVarName, String functionName,
                                                                     String officialName, RDFTermType rootRdfTermType, boolean isDistinct, boolean isPop,
                                                                     boolean isShortName, GetDBFunctionSymbolFunction getDBFunctionSymbolFunction) {
        super(functionName + (!isShortName ? (isPop ? "_POP" : "_SAMPLE") : "") + (isDistinct ? "_DISTINCT" : ""), officialName, isDistinct, rootRdfTermType, defaultAggVarName);
        this.defaultAggVarName = defaultAggVarName;
        this.isPop = isPop;
        this.getDBFunctionSymbolFunction = getDBFunctionSymbolFunction;
    }
    ...
    protected ImmutableFunctionalTerm createAggregate(ConcreteNumericRDFDatatype rdfType, ImmutableTerm dbTerm,
        ...
        return getDBFunctionSymbolFunction.get(this, termFactory, dbTerm, dbType);
    }
    ...
    protected AggregationSimplification decomposeMultityped(ImmutableTerm subTerm,
        ...
        Optional<Variable> optionalNumAvgVariable = optionalNumSubVariable
                .map(v -> variableGenerator.generateNewVariable(defaultAggVarName));
    ...
    protected interface GetDBFunctionSymbolFunction {
        ImmutableFunctionalTerm get(AbstractStatisticalSPARQLAggregationFunctionSymbolImpl sparqlFunction, TermFactory termFactory, ImmutableTerm dbTerm, DBTermType dbType);
    }
}
