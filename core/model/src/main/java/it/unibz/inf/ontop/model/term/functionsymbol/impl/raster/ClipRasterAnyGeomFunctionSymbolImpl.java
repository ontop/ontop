...
public class ClipRasterAnyGeomFunctionSymbolImpl extends AbstractRasterFunctionSymbolImpl {
    ...
    public ClipRasterAnyGeomFunctionSymbolImpl(@Nonnull IRI functionIRI, RDFDatatype xsdDatetime, RDFDatatype xsdStringDatatype) {
        super("RAS_CLIP_RASTER_SPATIAL_ANY_GEOM", functionIRI, ImmutableList.of(xsdDatetime, xsdStringDatatype, xsdStringDatatype), xsdStringDatatype);
    }
