...
public class SampleSPARQLFunctionSymbolImpl extends SPARQLFunctionSymbolImpl
    ...
    protected SampleSPARQLFunctionSymbolImpl(TypeFactory typeFactory) {
        this("SP_SAMPLE", SPARQL.SAMPLE, typeFactory);
    }
    protected SampleSPARQLFunctionSymbolImpl(String name, String officialName, TypeFactory typeFactory) {
        ...
        this.defaultAggVariableName = "sample1";
    }
    ...
    private ImmutableFunctionalTerm createAggregate(RDFTermType rdfType, ImmutableTerm dbSubTerm, TermFactory termFactory) {
        ...
        return termFactory.getDBSample(dbSubTerm, dbType);
    }
    ...
    private ImmutableList<Map.Entry<ImmutableExpression, RDFTermTypeConstant>> computeTypeTermWhenPairs(
        ...
        Stream<Map.Entry<ImmutableExpression, RDFTermTypeConstant>> numericEntries = computeNumericOrDatetimeTypePairs(
                ...
                (agg1, agg2) -> termFactory.getDBNumericInequality(InequalityLabel.LT, agg1, agg2),
                termFactory);
        ...
        Stream<Map.Entry<ImmutableExpression, RDFTermTypeConstant>> datetimeEntries = computeNumericOrDatetimeTypePairs(
                ...
                (agg1, agg2) -> termFactory.getDBDatetimeInequality(InequalityLabel.LT, agg1, agg2),
                termFactory);
