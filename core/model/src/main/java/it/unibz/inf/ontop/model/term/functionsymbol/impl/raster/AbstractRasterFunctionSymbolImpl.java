...
public abstract class AbstractRasterFunctionSymbolImpl extends ReduciblePositiveAritySPARQLFunctionSymbolImpl {
    private final RDFDatatype xsdDoubleType;

    protected AbstractRasterFunctionSymbolImpl(
