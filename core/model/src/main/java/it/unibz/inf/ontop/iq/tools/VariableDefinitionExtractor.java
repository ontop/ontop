...
public class VariableDefinitionExtractor {
     ...
     */
    public static ImmutableSet<ImmutableTerm> extract(Variable variable, QueryNode node, IntermediateQuery query) {
    ...
    public static ImmutableSet<ImmutableTerm> extract(Variable variable, IntermediateQuery query) {
     ...
     * Recursive
     */
    private static Stream<ImmutableTerm> getDefinitions(Variable initialVariable, Variable currentVariable,
    ...
    private static ImmutableTerm substitute(Variable initialVariable, Variable currentVariable, ImmutableTerm def) {
