...
public class CDataDynamoDBDBNotFunctionSymbol extends DBBooleanFunctionSymbolImpl implements DBNotFunctionSymbol {

    protected CDataDynamoDBDBNotFunctionSymbol(DBTermType dbBooleanTermType) {
        super("IS_FALSE", ImmutableList.of(dbBooleanTermType), dbBooleanTermType);
    }
