...
public class VarianceSPARQLFunctionSymbolImpl extends UnaryNumericSPARQLAggregationFunctionSymbolImpl {
    ...
    private VarianceSPARQLFunctionSymbolImpl(RDFTermType rootRdfTermType, boolean isPop, boolean isDistinct, boolean shortName) {
        super("SP_VARIANCE"+ (!shortName ? (isPop ? "_POP" : "_SAMPLE") : "") + (isDistinct ? "_DISTINCT" : ""), shortName ? AGG.VARIANCE.getIRIString() : (isPop ? AGG.VAR_POP.getIRIString() : AGG.VAR_SAMP.getIRIString()), isDistinct, rootRdfTermType, DEFAULT_AGG_VAR_NAME);
        this.isPop = isPop;
    }
    ...
    protected ImmutableFunctionalTerm createAggregate(ConcreteNumericRDFDatatype rdfType, ImmutableTerm dbTerm,
        ...
        return termFactory.getDBVariance(dbTerm, dbType, isPop, isDistinct());
    }
