...
import it.unibz.inf.ontop.model.term.functionsymbol.MetaRDFTermTypeFunctionSymbol;
...
public class MetaRDFTermTypeFunctionSymbolImpl extends FunctionSymbolImpl implements MetaRDFTermTypeFunctionSymbol {


    private final MetaRDFTermType metaType;
    private final ImmutableMap<DBConstant, RDFTermTypeConstant> conversionMap;

    protected MetaRDFTermTypeFunctionSymbolImpl(TypeFactory typeFactory,
                                                ImmutableMap<DBConstant, RDFTermTypeConstant> conversionMap) {
        super("metaConversion", ImmutableList.of(typeFactory.getDBTypeFactory().getDBBooleanType()));
