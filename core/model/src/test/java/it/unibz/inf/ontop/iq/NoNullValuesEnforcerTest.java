...
public class NoNullValuesEnforcerTest {
    ...
    private final static ImmutableExpression EQ_X_Y = DATA_FACTORY.getImmutableExpression(EQ, X, Y);
    private final static ImmutableExpression EQ_Y_Z = DATA_FACTORY.getImmutableExpression(EQ, Y, Z);
    private final static ImmutableExpression NOT_NULL_Z = DATA_FACTORY.getImmutableExpression(IS_NOT_NULL, Z);
    private final static ImmutableExpression NOT_NULL_X = DATA_FACTORY.getImmutableExpression(IS_NOT_NULL, X);
    ...
    private DBMetadata createMetadata() {
        BasicDBMetadata metadata = DBMetadataTestingTools.createDummyMetadata();
