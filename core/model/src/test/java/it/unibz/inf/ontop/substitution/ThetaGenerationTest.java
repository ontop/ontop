...
public class ThetaGenerationTest {
    ...
    public void test_1() {
        ...
        Optional<ImmutableSubstitution<ImmutableTerm>> s = SUBSTITUTION_FACTORY.unify(t1, t2);
...
//		}
    ...
    public void test_9() {
        ...
        Optional<ImmutableSubstitution<ImmutableTerm>> s = SUBSTITUTION_FACTORY.unify(t1, ot);
        assertFalse(s.isPresent());
    }
    ...
    public void test_10() {
        ...
        Optional<ImmutableSubstitution<ImmutableTerm>> s = SUBSTITUTION_FACTORY.unify(ot, t2);
        assertFalse(s.isPresent());
    }
    ...
    public void test_12() {
        ...
        Optional<ImmutableSubstitution<ImmutableTerm>> s = SUBSTITUTION_FACTORY.unify(ot1, ot2);
        assertFalse(s.isPresent());
    }
