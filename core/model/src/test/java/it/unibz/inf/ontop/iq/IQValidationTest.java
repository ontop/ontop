...
public class IQValidationTest {
    ...
    static {
        ...
        table11Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        ...
        table12Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        ...
        table13Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        ...
        table22Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        table22Def.addAttribute(idFactory.createAttributeID("col2"), integerDBType, false);
        ...
        table23Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        table23Def.addAttribute(idFactory.createAttributeID("col2"), integerDBType, false);
        ...
        table24Def.addAttribute(idFactory.createAttributeID("col1"), integerDBType, false);
        table24Def.addAttribute(idFactory.createAttributeID("col2"), integerDBType, false);
