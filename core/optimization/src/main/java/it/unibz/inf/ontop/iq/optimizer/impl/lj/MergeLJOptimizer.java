...
public class MergeLJOptimizer extends AbstractDelegatingIQTreeVariableGeneratorTransformer implements IQTreeVariableGeneratorTransformer {
        ...
        private class SimplificationContext {
            ...
            private Optional<IQTree> tryToSimplify(ImmutableList<LeftJoinDecomposition> ancestors, IQTree currentLeftChild) {
                ...
                if (renaming.isEmpty()) {
                    ...
                    newLocalRightTreeBeforeRenaming = rightProvenanceNormalizer.normalizeRightProvenance(
                            mergedLocalRightBeforeRenaming, leftLJ.getTree().getVariables(), variableGenerator, mergedLocalRightBeforeRenaming.getVariableNullability())
                            .getTree();
                }
