    ...
    public static class LiftState {
        ...
        protected ChildDefinitionLift liftDefinition(IQTree childTree, int position, Variable variable,
            ...
            ImmutableTerm originalDefinition = originalSubstitution
                    .map(s -> SubstitutionOperations.onImmutableTerms().apply(s, variable))
                    .orElse(variable);
            ...
            ImmutableTerm liftedDefinition = SubstitutionOperations.onImmutableTerms().applyToTerm(renamingSubstitution, originalDefinition);
