 ...
 *
 */
public class DefaultTermTypeTermVisitingTreeTransformer implements TermTypeTermLiftTransformer {
    ...
    private class Transformer extends DefaultRecursiveIQTreeVisitingTransformer {
        ...
        Transformer() {
            super(DefaultTermTypeTermVisitingTreeTransformer.this.iqFactory);
        }
