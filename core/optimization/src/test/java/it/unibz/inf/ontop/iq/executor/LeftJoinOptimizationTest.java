...
public class LeftJoinOptimizationTest {
    ...
    public void testMergeLJs27() {
        ...
        ExtensionalDataNode newRightDataNode = IQ_FACTORY.createExtensionalDataNode(TABLE7, ImmutableMap.of(0, F, 1, CF3,2, DF4));
        ...
        ConstructionNode newConstructionNode = IQ_FACTORY.createConstructionNode(projectionAtom.getVariables(),
                // Could be removed
                SUBSTITUTION_FACTORY.getSubstitution(
                        C, TERM_FACTORY.getIfElseNull(TERM_FACTORY.getDBIsNotNull(F), CF3),
                        D, TERM_FACTORY.getIfElseNull(TERM_FACTORY.getDBIsNotNull(F), DF4)
                ));
