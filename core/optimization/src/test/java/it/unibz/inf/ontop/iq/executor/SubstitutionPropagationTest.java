...
public class SubstitutionPropagationTest {
    ...
    private static final ImmutableList<Template.Component> URI_TEMPLATE_STR_2 = Template.builder().string("http://example.org/ds2/").placeholder().string("/").placeholder().build();
