...
public class QueryMergingTest {
    ...
    private static ExtensionalDataNode DATA_NODE_1 = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), A, B));
    private static ExtensionalDataNode DATA_NODE_3 = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE3_AR2.getAtomPredicate(), B, C));
    private static ExtensionalDataNode DATA_NODE_4 = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), S, T));
    ...
    public void testPruning1() throws EmptyQueryException {
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE3_AR2.getAtomPredicate(), B, ONE_STR));
    ...
    public void testEx1() throws EmptyQueryException {
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), A, THREE_STR));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx2() throws EmptyQueryException {
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), A, A));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx3() throws EmptyQueryException {
        ...
        QueryNode expectedRootNode = mainQuery.getRootNode();
        expectedBuilder.init(mainQuery.getProjectionAtom(), expectedRootNode);
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), X, INT_OF_THREE));
    ...
    public void testEx4() throws EmptyQueryException {
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), X, X));
        expectedBuilder.addChild(expectedRootNode, expectedDataNode);
    ...
    public void testEx5() throws EmptyQueryException {
         ...
         * Sub-query
         */
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), S, U));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(P1_ST_ATOM.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
                        T, S,
    ...
    public void testEx6() throws EmptyQueryException {
         ...
         * Sub-query
         */
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), S, B));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(P1_ST_ATOM.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
                        T, INT_OF_B,
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), X, THREE_STR));
        expectedBuilder.addChild(expectedRootNode, expectedDataNode);
    ...
    public void testEx7() throws EmptyQueryException {
        ...
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE4_AR3.getAtomPredicate(), A, B, C));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE4_AR3.getAtomPredicate(), A, A, A));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx8WithEx15() throws EmptyQueryException {
        ...
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), A, B));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(p1Atom.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
                        S, generateURI1(A),
    ...
    public void testEx9() throws EmptyQueryException {
        ...
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR3.getAtomPredicate(), A, B, C));
        subQueryBuilder.addChild(constructionNode2, dataNodeSubquery);
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR3.getAtomPredicate(), A, A, A));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx10() throws EmptyQueryException {
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), B, B));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx11() throws EmptyQueryException {
         ...
         * Sub-query
         */
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE2_AR1.getAtomPredicate(), A));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(P1_ST_ATOM.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
                        S, generateURI1(A),
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE2_AR1.getAtomPredicate(), A));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx12() throws EmptyQueryException {
         ...
         * Sub-query
         */
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), A, INT_OF_ONE));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(P1_ST_ATOM.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
                        S, generateURI1(A),
        ...
        ExtensionalDataNode expectedDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), INT_OF_ONE, INT_OF_ONE));
        expectedBuilder.addChild(remainingConstructionNode, expectedDataNode);
    ...
    public void testEx13() throws EmptyQueryException {
         ...
         * Sub-query
         */
        ExtensionalDataNode dataNodeSubquery = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), INT_OF_ONE, B));
        IntermediateQueryBuilder subQueryBuilder = createQueryBuilder();
        ConstructionNode subQueryRoot = IQ_FACTORY.createConstructionNode(P1_ST_ATOM.getVariables(),
                SUBSTITUTION_FACTORY.getSubstitution(ImmutableMap.of(
    ...
    public void testEx14() {
        ...
        ExtensionalDataNode tableNode = IQ_FACTORY.createExtensionalDataNode(
                ATOM_FACTORY.getDataAtom(TABLE1_AR2.getAtomPredicate(), two, two));
    ...
    public void testConflictingVariables() {
        ...
        ExtensionalDataNode firstNameDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE4_AR3.getAtomPredicate(), A, B, C));
        ...
        ExtensionalDataNode lastNameDataNode = IQ_FACTORY.createExtensionalDataNode(ATOM_FACTORY.getDataAtom(TABLE4_AR3.getAtomPredicate(), D, E, B));
    ...
    public void testUnionSameVariable() {
        ...
        ExtensionalDataNode extensionalDataNode1 = IQ_FACTORY.createExtensionalDataNode(
                ATOM_FACTORY.getDataAtom(TABLE1_AR1.getAtomPredicate(), X));
        ...
        ExtensionalDataNode extensionalDataNode2 = IQ_FACTORY.createExtensionalDataNode(
                ATOM_FACTORY.getDataAtom(TABLE2_AR1.getAtomPredicate(), X));
    ...
    public void testDescendingSubstitutionOnRenamedNode() {
        ...
        mappingBuilder.init(mappingProjectionAtom, mappingRootNode);
        ExtensionalDataNode extensionalDataNode1 = IQ_FACTORY.createExtensionalDataNode(
                ATOM_FACTORY.getDataAtom(TABLE4_AR1.getAtomPredicate(), X));
