...
public class FederationOptimizerTest {
    ...
    // TODO: make proper Test. This is only a copy from FlattenLiftTest. and compares the generated IQ with the same input IQ
    @Test
    public void testFederationOptimizer() {
    ...
    private static void optimizeAndCompare(IQ query, IQ expectedQuery) {
        ...
        IQ optimizedIQ = FEDERATION_OPTIMIZER.optimize(query);
        System.out.println("\nAfter optimization: \n" +  optimizedIQ);
