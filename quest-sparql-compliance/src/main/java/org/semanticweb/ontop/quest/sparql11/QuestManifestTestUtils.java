package org.semanticweb.ontop.quest.sparql11;
...
public class QuestManifestTestUtils {
	...
	public static TestSuite suite(SPARQLQueryParent.Factory factory) throws Exception
	{
		...
		URL url = QuestManifestTestUtils.class.getResource("/testcases-dawg-sparql-1.1/manifest-all.ttl");

		if ("jar".equals(url.getProtocol())) {
			// Extract manifest files to a temporary directory
			try {
				tmpDir = FileUtil.createTempDir("sparql11-evaluation");
