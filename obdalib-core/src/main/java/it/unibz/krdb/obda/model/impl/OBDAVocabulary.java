...
public class OBDAVocabulary {
	...
	public static final Predicate SPARQL_IS_LITERAL = new BooleanOperationPredicateImpl("isLiteral", 1);
	public static final Predicate SPARQL_IS_URI = new BooleanOperationPredicateImpl("isURI", 1);
	public static final Predicate SPARQL_IS_IRI = new BooleanOperationPredicateImpl("isIRI", 1);
	public static final Predicate SPARQL_IS_BLANK = new BooleanOperationPredicateImpl("isBlank", 1);
