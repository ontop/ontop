 ...
 *
 */
public class ImplicitDBConstraintsReader {
	
	private static Logger log = LoggerFactory.getLogger(ImplicitDBConstraintsReader.class);
	...
	/**
	 * Reads unique and foreign-key constraints from the file
	 * 
	 * @param file The plain text file with unique and foreign-key constraints
	 */
	public ImplicitDBConstraintsReader(File file) {
