...
public class MetaMappingTargetQueryValidatorTest extends TestCase {
	...
	public void testValidate() throws IOException, InvalidMappingException, DuplicateMappingException {
		...
		/**
		 * TODO: should use a configuration closer from the mapping (no need for query answering)
		 */
		OntopStandaloneSQLConfiguration configuration = OntopStandaloneSQLConfiguration.defaultBuilder()
