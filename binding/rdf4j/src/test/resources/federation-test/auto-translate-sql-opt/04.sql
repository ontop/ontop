...
FROM ((SELECT v11."label10m9" AS "label10m9", v11."product0m8" AS "product0m8", v11."propertytex1m10" AS "propertytex1m10"
FROM (SELECT DISTINCT v9."label10m9" AS "label10m9", v9."product0m8" AS "product0m8", v9."propertynum1m41" AS "propertynum1m41", v9."propertytex1m10" AS "propertytex1m10"
FROM ((SELECT v1."label" AS "label10m9", v1."nr" AS "product0m8", v1."propertynum1" AS "propertynum1m41", v1."propertytex1" AS "propertytex1m10"
...
FROM (SELECT DISTINCT v21."label10m9" AS "label10m9", v21."product0m8" AS "product0m8", v21."propertynum1m40" AS "propertynum1m40", v21."propertytex1m10" AS "propertytex1m10"
FROM ((SELECT v13."label" AS "label10m9", v13."nr" AS "product0m8", v13."propertynum2" AS "propertynum1m40", v13."propertytex1" AS "propertytex1m10"
