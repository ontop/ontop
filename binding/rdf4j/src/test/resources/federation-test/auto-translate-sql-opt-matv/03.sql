...
FROM (SELECT DISTINCT v11."label10m10" AS "label10m10", v11."label10m46" AS "label10m46", v11."product0m2" AS "product0m2", CASE WHEN v11."label10m10" IS NOT NULL THEN v11."product0m2" ELSE NULL END AS "product0m4", v11."propertynum1m26" AS "propertynum1m26", v11."propertynum1m41" AS "propertynum1m41"
FROM ((SELECT v4."label" AS "label10m10", v1."label" AS "label10m46", v1."nr" AS "product0m2", v1."propertynum3" AS "propertynum1m26", v1."propertynum1" AS "propertynum1m41"
