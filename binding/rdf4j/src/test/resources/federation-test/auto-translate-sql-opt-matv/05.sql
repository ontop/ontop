...
FROM (
      SELECT DISTINCT v7."label10m46" AS "label10m46", v7."product0m4" AS "product0m4", v7."productfeature2m2" AS "productfeature2m2", v7."propertynum1m10" AS "propertynum1m10", v7."propertynum1m15" AS "propertynum1m15", v22."propertynum1m40" AS "propertynum1m40", v17."propertynum1m41" AS "propertynum1m41"
      FROM (
            (
           ...
           (
             ...
             WHERE (v4."label" IS NOT NULL AND v4."propertynum1" IS NOT NULL AND v4."propertynum2" IS NOT NULL AND v4."nr" <> 88 AND v4."nr" = v5."product")
                 ...
                 (
                  SELECT v8."productfeature" AS "productfeature2m0"
                 ...
                 (
                  ...
                  WHERE 88 = v10."product"
                        ...
                        (
                         SELECT v13."propertynum1" AS "propertynum1m41"
                        ...
                        (
                         ...
                         WHERE (v15."propertynum1" IS NOT NULL AND 88 = v15."nr")
                               ...
                               (
                                SELECT v18."propertynum2" AS "propertynum1m40"
