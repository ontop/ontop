...
WHERE ((1 <= v1."1_1") AND (v1."1_1" <= 500) AND v2."label" IS NOT NULL AND v2."homepage" IS NOT NULL AND v1."1_8" IS NOT NULL AND v1."1_4" IS NOT NULL AND v1."1_7" IS NOT NULL AND v1."1_6" IS NOT NULL AND v1."2_1" IS NOT NULL AND v1."1_3" = v2."nr")
)UNION ALL 
...
WHERE ((1 <= v4."1_1") AND (v4."1_1" <= 500) AND v5."label" IS NOT NULL AND v5."homepage" IS NOT NULL AND v4."1_8" IS NOT NULL AND v4."1_4" IS NOT NULL AND v4."1_7" IS NOT NULL AND v4."1_6" IS NOT NULL AND v4."2_1" IS NOT NULL AND v4."1_3" = v5."nr")
)) v7
