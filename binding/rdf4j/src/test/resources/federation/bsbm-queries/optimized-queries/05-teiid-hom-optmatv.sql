...
FROM "s1"."product1" v1, "s1"."productfeatureproduct1" v2
...
FROM "s5"."product2" v4, "s5"."productfeatureproduct2" v5
...
FROM "s1"."productfeatureproduct1" v8, "s1"."product1" v9
...
FROM "s5"."productfeatureproduct2" v11, "s5"."product2" v12
