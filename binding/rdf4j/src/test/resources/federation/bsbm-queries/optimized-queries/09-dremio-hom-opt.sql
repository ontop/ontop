...
WHERE (v2."name" IS NOT NULL AND v2."mbox_sha1sum" IS NOT NULL AND v2."country" IS NOT NULL AND v3."nr" IS NOT NULL AND v3."product" IS NOT NULL AND v3."title" IS NOT NULL AND v1."person" = v2."nr" AND v1."person" = v3."person" AND 1356 = v1."nr")
