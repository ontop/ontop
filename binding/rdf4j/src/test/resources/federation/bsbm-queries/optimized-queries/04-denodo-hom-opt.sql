SELECT DISTINCT v31."label10m13" AS "label10m13", v31."nr0m12" AS "nr0m12", v31."propertytex1m14" AS "propertytex1m14", v31."v25" AS "v25"
FROM (SELECT v29."label10m13" AS "label10m13", v29."nr0m12" AS "nr0m12", v29."propertytex1m14" AS "propertytex1m14", v29."label10m13" AS "v25"
...
WHERE ((v1."propertynum1" > 53) AND v1."nr" = v2."product" AND v1."nr" = v3."product" AND v1."nr" = v4."product" AND 4 = v2."producttype" AND 90 = v3."productfeature" AND 79 = v4."productfeature")
)UNION ALL 
...
WHERE ((v6."propertynum1" > 53) AND v6."nr" = v7."product" AND v6."nr" = v8."product" AND v6."nr" = v9."product" AND 4 = v7."producttype" AND 90 = v8."productfeature" AND 79 = v9."productfeature")
)) v11
) v13
)UNION ALL 
...
FROM "product1" v15, "producttypeproduct1" v16, "productfeatureproduct1" v17, "productfeatureproduct1" v18
WHERE ((v15."propertynum2" > 134) AND v15."nr" = v16."product" AND v15."nr" = v17."product" AND v15."nr" = v18."product" AND 4 = v16."producttype" AND 90 = v17."productfeature" AND 116 = v18."productfeature")
)UNION ALL 
(SELECT v20."label" AS "label10m13", v20."nr" AS "nr0m12", v20."propertynum2" AS "propertynum1m35", v20."propertytex1" AS "propertytex1m14"
FROM "product2" v20, "producttypeproduct2" v21, "productfeatureproduct2" v22, "productfeatureproduct2" v23
WHERE ((v20."propertynum2" > 134) AND v20."nr" = v21."product" AND v20."nr" = v22."product" AND v20."nr" = v23."product" AND 4 = v21."producttype" AND 90 = v22."productfeature" AND 116 = v23."productfeature")
)) v25
) v27
)) v29
) v31
ORDER BY v31."v25" ASC NULLS FIRST
OFFSET 5 ROWS
