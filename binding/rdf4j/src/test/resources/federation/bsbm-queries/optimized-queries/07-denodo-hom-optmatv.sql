...
WHERE ((v6."validto" > '2008-06-13') AND v6."price" IS NOT NULL AND v7."label" IS NOT NULL AND v6."validto" IS NOT NULL AND v6."vendor" = v7."nr" AND 94 = v6."product" AND 'DE' = v7."country")
) v9 ON 1 = 1 
 LEFT OUTER JOIN 
