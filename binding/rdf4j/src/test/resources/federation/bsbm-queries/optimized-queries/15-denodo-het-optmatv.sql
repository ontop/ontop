...
WHERE ((1 <= v1."1_1") AND (v1."1_1" <= 500) AND v2."label" IS NOT NULL AND v2."homepage" IS NOT NULL AND v1."1_8" IS NOT NULL AND v1."1_4" IS NOT NULL AND v1."1_7" IS NOT NULL AND v1."1_6" IS NOT NULL AND v1."1_0" IS NOT NULL AND v1."2_1" IS NOT NULL AND v1."1_3" = v2."nr")
)UNION ALL 
