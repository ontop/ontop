...
WHERE ((v1."1_7" <= 3) AND (1 <= v1."1_1") AND (v1."1_1" <= 500) AND v1."1_7" IS NOT NULL AND v1."1_4" IS NOT NULL AND v1."1_6" IS NOT NULL AND v1."1_3" = v2."nr" AND 'US' = v2."country")
)UNION ALL 
...
WHERE ((v4."1_7" <= 3) AND (1 <= v4."1_1") AND (v4."1_1" <= 500) AND v4."1_7" IS NOT NULL AND v4."1_4" IS NOT NULL AND v4."1_6" IS NOT NULL AND v4."1_3" = v5."nr" AND 'US' = v5."country")
)) v7
