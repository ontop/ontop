SELECT DISTINCT v21."label10m11" AS "label10m11", v21."label10m40" AS "label10m40", v21."nr0m49" AS "nr0m49", CASE WHEN v21."label10m11" IS NOT NULL THEN v21."nr0m49" ELSE NULL END AS "product0m5", v21."propertynum1m23" AS "propertynum1m23", v21."propertynum1m36" AS "propertynum1m36"
...
FROM "bsbm"."product1" v1, "bsbm"."producttypeproduct1" v2, "bsbm"."productfeatureproduct1" v3
WHERE ((v1."propertynum3" < 1874) AND (v1."propertynum1" > 53) AND v1."nr" = v2."product" AND v1."nr" = v3."product" AND 4 = v2."producttype" AND 79 = v3."productfeature")
) v5
 LEFT OUTER JOIN 
(SELECT v7."label" AS "label10m11", v6."product" AS "nr0m0", v7."nr" AS "nr0m5", v6."productfeature" AS "v6"
FROM "bsbm"."productfeatureproduct1" v6, "bsbm"."product1" v7
WHERE (v6."product" = v7."nr" AND 814 = v6."productfeature")
...
FROM "bsbm"."product2" v11, "bsbm"."producttypeproduct2" v12, "bsbm"."productfeatureproduct2" v13
WHERE ((v11."propertynum3" < 1874) AND (v11."propertynum1" > 53) AND v11."nr" = v12."product" AND v11."nr" = v13."product" AND 4 = v12."producttype" AND 79 = v13."productfeature")
) v15
 LEFT OUTER JOIN 
(SELECT v17."label" AS "label10m11", v17."nr" AS "nr0m12", v16."product" AS "nr0m7", v16."productfeature" AS "v13"
FROM "bsbm"."productfeatureproduct2" v16, "bsbm"."product2" v17
WHERE (v16."product" = v17."nr" AND 814 = v16."productfeature")
) v19 ON v15."nr0m49" = v19."nr0m7" 
WHERE v19."label10m11" IS NULL
)) v21
ORDER BY v21."label10m40" NULLS FIRST
LIMIT 10