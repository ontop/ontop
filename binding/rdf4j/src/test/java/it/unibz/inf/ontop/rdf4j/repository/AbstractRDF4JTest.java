...
public class AbstractRDF4JTest {
    ...
    protected static void initOBDA(String dbScriptRelativePath, String obdaRelativePath, String owlRelativePath) throws SQLException, IOException {
        ...
        OntopSQLOWLAPIConfiguration config = OntopSQLOWLAPIConfiguration.defaultBuilder()
                .nativeOntopMappingFile(AbstractRDF4JTest.class.getResource(obdaRelativePath).getPath())
                .ontologyFile(AbstractRDF4JTest.class.getResource(owlRelativePath).getPath())
                .jdbcUrl(jdbcUrl)
                .jdbcUser(USER)
                .jdbcPassword(PASSWORD)
                .enableTestMode()
