...
public class ClusteringPatternTest {
    // Reference
    private static final String referenceOBDAPath = "src/test/resources/bootstrapper.clustering/reference-clustering.obda";
    private static final String referenceOWLPath = "src/test/resources/bootstrapper.clustering/reference-clustering.owl";

    // DB-connection
    private static final String owlPath = "src/test/resources/bootstrapper.clustering/clustering.owl";
    private static final String obdaPath = "src/test/resources/bootstrapper.clustering/clustering.obda";
    private static final String propertyPath = "src/test/resources/bootstrapper.clustering/clustering.properties";

    // Bootstrapping-info
    private static final String BASE_IRI = "http://semanticweb.org/clustering/";
    private static final String bootOwlPath = "src/test/resources/bootstrapper.clustering/boot-clustering.owl";
    private static final String bootOBDAPath = "src/test/resources/bootstrapper.clustering/boot-clustering.obda";

    // Bootstrapper conf file
    private static final String CONF_FILE = "src/test/resources/bootstrapper.clustering/boot-conf.json";
    ...
    private static Bootstrapper.BootstrappingResults bootstrapMPMapping(OntopSQLOWLAPIConfiguration initialConfiguration,
        ...
        MPBootstrapper bootstrapper = Bootstrapper.mpBootstrapper();
