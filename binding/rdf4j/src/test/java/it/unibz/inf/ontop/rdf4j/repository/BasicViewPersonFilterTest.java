...
public class BasicViewPersonFilterTest extends AbstractRDF4JTest {
    ...
    private static final String VIEW_FILE = "/person/views/basic_views_filterexp.json";
    ...
    public void testPersonFullName() throws Exception {
        String query = "PREFIX : <http://person.example.org/>\n" +
                ...
                "}";
        runQueryAndCompare(query, ImmutableList.of("JOHN DOE Belfast"));
    }
}
