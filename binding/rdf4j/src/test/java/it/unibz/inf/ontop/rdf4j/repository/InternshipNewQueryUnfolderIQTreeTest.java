...
public class InternshipNewQueryUnfolderIQTreeTest {
    ...
    static {
        ...
        try {
            ...
            INTERNSHIP_UNFOLDER = (InternshipQueryUnfolder) QUERYUNFOLDER_FACTORY.create(specification.getSaturatedMapping());
        } catch (OBDASpecificationException e) {
            throw new RuntimeException(e);
        }
    }

    private DistinctVariableOnlyDataAtom automaticallyConstructProjectAtom(VariableOrGroundTerm sub, VariableOrGroundTerm pred, VariableOrGroundTerm obj){
        int countVar = 0;
    ...
    private void checkForSimpleTripleUnfoldingInFirstPhase(VariableOrGroundTerm sub, VariableOrGroundTerm pred, VariableOrGroundTerm obj){
        ...
        //costruzione albero
        DistinctVariableOnlyDataAtom projectionAtom = automaticallyConstructProjectAtom(sub, pred, obj);
    ...
    @Test
    public void tripleVarVarVarAndUnfoldedMappingShouldBeSmallerThanAllDefinitions(){
        //costruzione albero
        DistinctVariableOnlyDataAtom projectionAtom = automaticallyConstructProjectAtom(A, B, C);
