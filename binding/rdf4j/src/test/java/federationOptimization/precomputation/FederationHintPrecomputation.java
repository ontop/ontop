...
//        }
    ...
    public void myTestWithUpdatedConfig() throws Exception {
        ...
        String folder = "src/test/resources/federation/";

        SourceHints sh = detectCandidateHints(
                folder + "ontology.owl",
                folder + (system.equals("teiid") ? "mappings.fed.teiid.obda" : "mappings.fed.obda"),
                folder + "system-" + system + "-" + setting + ".properties",
                folder + "source_dynamicity_labels." + setting + ".txt",
                folder + "source_relations." + setting + ".txt");
