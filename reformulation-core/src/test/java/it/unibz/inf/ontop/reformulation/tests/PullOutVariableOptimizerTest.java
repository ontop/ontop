...
public class PullOutVariableOptimizerTest {
    ...
    private final static Variable X1 = DATA_FACTORY.getVariable("Xf0");
    private final static Variable X2 = DATA_FACTORY.getVariable("Xf1");
    private final static Variable X3 = DATA_FACTORY.getVariable("Xf2");
    ...
    public void testJoiningConditionTest1() throws EmptyQueryException {
        ...
        ExtensionalDataNode dataNode3 = new ExtensionalDataNodeImpl(DATA_FACTORY.getDataAtom(TABLE2_PREDICATE, X1, Z));
    ...
    public void testJoiningConditionTest2() throws EmptyQueryException {
        ...
        ExtensionalDataNode dataNode3 = new ExtensionalDataNodeImpl(DATA_FACTORY.getDataAtom(TABLE4_PREDICATE, X1, Y1, Z));
    ...
    public void testJoiningConditionTest3() throws EmptyQueryException {
        ...
        LeftJoinNode leftJoinNode2 = new LeftJoinNodeImpl(ImmutabilityTools.foldBooleanExpressions(EXPRESSION3, EXPRESSION4, EXPRESSION2));
        ExtensionalDataNode dataNode3 =  new ExtensionalDataNodeImpl(DATA_FACTORY.getDataAtom(TABLE1_PREDICATE, X, X1, Y));
        ExtensionalDataNode dataNode4 = new ExtensionalDataNodeImpl(DATA_FACTORY.getDataAtom(TABLE4_PREDICATE, X2, Y1, X3));

        queryBuilder2.init(projectionAtom2, constructionNode2);
        queryBuilder2.addChild(constructionNode2, leftJoinNode2);
        queryBuilder2.addChild(leftJoinNode2, filterNode, NonCommutativeOperatorNode.ArgumentPosition.LEFT);
        queryBuilder2.addChild(filterNode, dataNode3);
        queryBuilder2.addChild(leftJoinNode2, dataNode4, NonCommutativeOperatorNode.ArgumentPosition.RIGHT);
