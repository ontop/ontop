...
public class PushDownBooleanExpressionOptimizerTest {
    ...
    public void testJoiningConditionTest3 () throws EmptyQueryException {
        ...
        queryBuilder1.addChild(leftJoinNode, dataNode1, NonCommutativeOperatorNode.ArgumentPosition.LEFT);
        queryBuilder1.addChild(leftJoinNode, dataNode2, NonCommutativeOperatorNode.ArgumentPosition.RIGHT);
