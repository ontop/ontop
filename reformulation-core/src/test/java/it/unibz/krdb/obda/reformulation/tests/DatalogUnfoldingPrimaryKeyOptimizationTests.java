...
public class DatalogUnfoldingPrimaryKeyOptimizationTests extends TestCase {
	...
	public void setUp() {
		...
		Function body = fac.getFunctionalTerm(fac.getPredicate("TABLE", 4), bodyTerms);
		...
		bodyTerms.add(fac.getVariable("z"));
		bodyTerms.add(fac.getVariable("m"));
		body = fac.getFunctionalTerm(fac.getPredicate("TABLE", 4), bodyTerms);
		...
		bodyTerms.add(fac.getVariable("z"));
		bodyTerms.add(fac.getVariable("m"));
		body = fac.getFunctionalTerm(fac.getPredicate("TABLE2", 4), bodyTerms);
		rule = fac.getCQIE(head, body);
		unfoldingProgram.appendRule(rule);
	...
	public void testRedundancyElimination() throws Exception {
		...
		Function head = fac.getFunctionalTerm(fac.getPredicate("q", 4), headterms);
		List<Function> body = new LinkedList<Function>();
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("name"), fac.getVariable("m"), fac.getVariable("n")));
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("lastname"), fac.getVariable("m"), fac.getVariable("o")));
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("id"), fac.getVariable("m"), fac.getVariable("p")));
		...
		head = fac.getFunctionalTerm(fac.getPredicate("q", 4), headterms);
		body = new LinkedList<Function>();
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("name"), fac.getVariable("s1"), fac.getVariable("x")));
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("name"), fac.getVariable("s2"), fac.getVariable("m")));
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("lastname"), fac.getVariable("s1"), fac.getVariable("y")));
		body.add(fac.getFunctionalTerm(fac.getDataPropertyPredicate("lastname"), fac.getVariable("s2"), fac.getVariable("o")));
