...
import it.unibz.inf.ontop.executor.expression.PushDownBooleanExpressionExecutorImpl;
import it.unibz.inf.ontop.executor.expression.PushUpBooleanExpressionExecutorImpl;
...
public class IntermediateQueryImpl implements IntermediateQuery {
    ...
    static {
        ...
        internalExecutorMapBuilder.put(PushDownBooleanExpressionProposal.class, PushDownBooleanExpressionExecutorImpl.class);
        internalExecutorMapBuilder.put(PushUpBooleanExpressionProposal.class, PushUpBooleanExpressionExecutorImpl.class);
