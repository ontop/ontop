...
public class SparqlAlgebraToDatalogTranslator {
    ...
    private Term getOntopTerm(Var subj) {
        ...
        if (s == null) {
            ...
            it.unibz.inf.ontop.model.ValueConstant constant = ofac.getConstantLiteral(value, objectType);
    ...
    private Term getConstantExpression(Value v) {
        ...
        if (v instanceof Literal) {
            ...
            it.unibz.inf.ontop.model.ValueConstant constant = ofac.getConstantLiteral(constantString, tp);
