...
import it.unibz.krdb.obda.owlrefplatform.core.BuiltinPredicate;
import it.unibz.krdb.obda.owlrefplatform.core.CQIE;
import it.unibz.krdb.obda.owlrefplatform.core.Function;
import it.unibz.krdb.obda.owlrefplatform.core.Predicate;
...
//						}
	...
	public int getUCQSizeAfterRewriting() {
		...
		if( programAfterRewriting.getRules() != null )
			result = programAfterRewriting.getRules().size();
