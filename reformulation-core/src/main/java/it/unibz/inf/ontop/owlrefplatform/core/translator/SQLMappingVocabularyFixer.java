...
public class SQLMappingVocabularyFixer implements MappingVocabularyFixer {
	...
	public OBDAModel fixOBDAModel(OBDAModel model, ImmutableOntologyVocabulary vocabulary,
        ...
        ImmutableList<OBDAMappingAxiom> sourceMapping = ImmutableList.copyOf(model.getMappings());

        try {
            mappings.addAll(fixMappingPredicates(sourceMapping, vocabulary, nativeQLFactory));
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        try {
            return model.newModel(ImmutableList.copyOf(mappings));
        } catch (DuplicateMappingException e) {
            throw new RuntimeException("Error: Duplicate Mappings generated by MappingVocabularyRepair.fixOBDAModel");
        }
    }
