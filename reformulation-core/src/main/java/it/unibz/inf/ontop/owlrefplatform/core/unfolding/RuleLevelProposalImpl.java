...
import static it.unibz.inf.ontop.model.impl.DatalogTools.constructNewFunction;
import static it.unibz.inf.ontop.model.impl.DatalogTools.isDataOrLeftJoinOrJoinAtom;
...
public class RuleLevelProposalImpl implements RuleLevelProposal {
    ...
    public RuleLevelProposalImpl(CQIE initialRule, HashMap<Predicate, PredicateLevelProposal> childProposalIndex)
         ...
         */
        typeProposal = TypeLiftTools.constructTypeProposal(typedRule.getHead());
    ...
    public CQIE getDetypedRule() {
        ...
        Function detypedHead = TypeLiftTools.removeTypeFromAtom(extendedTypedHead);
    ...
    private static Substitution aggregateRuleAndProposals(final Option<Substitution> optionalSubstitution,
        ...
        if (optionalChildProposal.isSome()) {
            try {
                ...
                Substitution proposedSubstitution = TypeLiftTools.computeTypePropagatingSubstitution(sourceAtom, bodyAtom);
                 ...
                 */
                    ...
                    newOptionalSubstitution = Option.some(SubstitutionUtilities.union(optionalSubstitution.some(),
