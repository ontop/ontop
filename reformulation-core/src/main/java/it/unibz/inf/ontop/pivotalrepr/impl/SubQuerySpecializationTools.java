 ...
 * TODO: explain
 */
public class SubQuerySpecializationTools {

    /**
     * TODO: explain
     */
    public static class SubQuerySpecializationException extends Exception {
        protected SubQuerySpecializationException(String message) {
            super(message);
        }
    }
    ...
    public static class SpecializationException extends Exception {
        ...
        protected SpecializationException() {
            super();
        }
    }
...
//     */
//    public static IntermediateQuery specializeSubQuery(final IntermediateQuery originalSubQuery,
//                                                       final DataAtom targetDataAtom,
//                                                       final ImmutableSet<Variable> reservedVariables)
//            throws SubQuerySpecializationException {
//
...
//         */
//        if (!originalSubQuery.getProjectionAtom().hasSamePredicateAndArity(targetDataAtom)) {
...
//            throws IntermediateQueryBuilderException, SubQuerySpecializationException {
...
//                throw new SubQuerySpecializationException(e.getMessage());
//            }
//
//            /**
...
//        VariableGenerator variableGenerator = new VariableGenerator(reservedVariables);
//        return IntermediateQueryUtils.generateNotConflictingRenaming(variableGenerator, subQuery.getKnownVariables());
//    }
//
//    /**
//     * TODO: explain
...
//            throw new SubQuerySpecializationException("Constraints could not be unified");
//        }
...
//            throw new SubQuerySpecializationException(originalAtom + " and " + newAtom
...
//    }
    ...
    public static NewSubstitutionPair traverseConstructionNode(
            ...
            ImmutableSet<Variable> formerV) throws SpecializationException {
        ...
        ImmutableSubstitution<ImmutableTerm> eta = computeMGUS(formerTheta, tauC)
                .orElseThrow(SpecializationException::new);
