...
public class RDBMSSIRepositoryManager implements Serializable {
	...
	static {
		...
		attribute_table.put(COL_TYPE.DATETIME_STAMP, "QUEST_DATA_PROPERTY_DATETIMESTAMP_ASSERTION"); // 15
		...
		attribute_type.put(COL_TYPE.DATETIME_STAMP, "TIMESTAMP");
	...
	public int insertData(Connection conn, Iterator<Assertion> data, int commitLimit, int batchLimit) throws SQLException {
        ...
        log.debug("Total successful insertions: " + (success-totalFailures) + ".");
