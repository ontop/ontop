...
public class DAGBuilderImpl implements DAGBuilder{
	...
	/**
	 * *Construct a DAG starting from a given graph with already known equivalent nodes and representative nodes
	 * @param graph
	 */
...
//						break;
	...
	/* Alterntative version but slower to eliminate redundances 
