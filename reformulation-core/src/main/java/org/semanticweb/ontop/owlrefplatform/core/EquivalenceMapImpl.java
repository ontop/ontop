...
public class EquivalenceMapImpl implements EquivalenceMap {
	...
	private EquivalenceMapImpl(Map<Predicate, Description> equivalenceMap) {
...
//			Description description = fac.createProperty(p);
	...
	*/
	...
	public static EquivalenceMap getEquivalenceMap(TBoxReasoner reasoner) {
		...
		return new EquivalenceMapImpl(equivalenceMap);
	}
	
	public static EquivalenceMap getEmptyEquivalenceMap() {
		return new EquivalenceMapImpl(Collections.<Predicate, Description> emptyMap());
	}
