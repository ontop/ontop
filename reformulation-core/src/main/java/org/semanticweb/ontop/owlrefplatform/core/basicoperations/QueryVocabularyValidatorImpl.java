...
public class QueryVocabularyValidatorImpl implements QueryVocabularyValidator {

	//private static final long serialVersionUID = -2901421485090507301L;

	private final Logger log = LoggerFactory.getLogger(QueryVocabularyValidatorImpl.class);
	...
	public QueryVocabularyValidatorImpl(Set<Predicate> vocabulary, EquivalenceMap equivalences) {
