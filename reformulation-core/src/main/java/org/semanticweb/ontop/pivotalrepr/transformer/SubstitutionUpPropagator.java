 ...
 *
 */
public class SubstitutionUpPropagator extends SubstitutionPropagator<SubstitutionUpPropagator.StopPropagationException,
     ...
     * TODO: explain
     */
    public static class StopPropagationException extends QueryNodeTransformationException {
    ...
    public SubstitutionUpPropagator(IntermediateQuery query, QueryNode descendantNode, ImmutableSubstitution substitution) {
        super(substitution);
        this.query = query;
