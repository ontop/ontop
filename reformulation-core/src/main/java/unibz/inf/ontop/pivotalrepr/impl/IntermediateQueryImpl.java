...
import unibz.inf.ontop.executor.deletion.ReactToChildDeletionExecutor;
import unibz.inf.ontop.executor.expression.PushDownExpressionExecutor;
import unibz.inf.ontop.executor.join.JoinInternalCompositeExecutor;
import unibz.inf.ontop.executor.substitution.SubstitutionPropagationExecutor;
import unibz.inf.ontop.model.DataAtom;
import unibz.inf.ontop.model.Variable;
import unibz.inf.ontop.executor.groundterm.GroundTermRemovalFromDataNodeExecutor;
import unibz.inf.ontop.executor.pullout.PullOutVariableExecutor;
import unibz.inf.ontop.executor.renaming.PredicateRenamingExecutor;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import unibz.inf.ontop.pivotalrepr.*;
import unibz.inf.ontop.pivotalrepr.proposal.*;
