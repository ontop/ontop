...
public class IQ2CQ {
    ...
    public static Optional<ImmutableList<ExtensionalDataNode>> getExtensionalDataNodes(IQTree tree, CoreSingletons coreSingletons) {
    ...
    private static class ValuesRelationDefinition extends AbstractRelationDefinition {
        ...
        private static AttributeListBuilder extractAttributes(ValuesNode valuesNode, DBTermType rootType, QuotedIDFactory idFactory) {
            AttributeListBuilder builder = AbstractRelationDefinition.attributeListBuilder();
