...
import it.unibz.inf.ontop.spec.mapping.parser.impl.QueryUtils;
...
public class TurtleOBDAParser_old {
...
//
//
//	public TurtleOBDAParser_old(TokenStream input) {
//		this(input, new RecognizerSharedState());
//	}
//	public TurtleOBDAParser_old(TokenStream input, RecognizerSharedState state) {
//		super(input, state);
//	}
//
//	@Override public String[] getTokenNames() { return TurtleOBDAParser_old.tokenNames; }
...
//	public final TurtleOBDAParser_old.namespace_return namespace() throws RecognitionException {
//		TurtleOBDAParser_old.namespace_return retval = new TurtleOBDAParser_old.namespace_return();
...
//	public final TurtleOBDAParser_old.defaultNamespace_return defaultNamespace() throws RecognitionException {
//		TurtleOBDAParser_old.defaultNamespace_return retval = new TurtleOBDAParser_old.defaultNamespace_return();
//		retval.start = input.LT(1);
//
//		try {
...
//	public final TurtleOBDAParser_old.languageTag_return languageTag() throws RecognitionException {
//		TurtleOBDAParser_old.languageTag_return retval = new TurtleOBDAParser_old.languageTag_return();
//		retval.start = input.LT(1);
//
//		try {
