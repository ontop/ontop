...
public class TurtleOBDALexer extends Lexer {
	...
	public final void mBASE() throws RecognitionException {
		try {
			int _type = BASE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:716:5: ( ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:716:7: ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
	...
	public final void mPREFIX() throws RecognitionException {
		try {
			int _type = PREFIX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:718:7: ( ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' ) )
			// TurtleOBDA.g:718:9: ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' )
			{
	...
	public final void mFALSE() throws RecognitionException {
		try {
			int _type = FALSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:720:6: ( ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:720:8: ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
			if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
				input.consume();
			}
	...
	public final void mTRUE() throws RecognitionException {
		try {
			int _type = TRUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:722:5: ( ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:722:7: ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' )
			{
	...
	public final void mUNDERSCORE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:741:11: ( '_' )
			// TurtleOBDA.g:741:16: '_'
			{
			match('_'); 
			}
	...
	public final void mBLANK_PREFIX() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:758:13: ( '_:' )
			// TurtleOBDA.g:758:16: '_:'
			{
			match("_:"); 
	...
	public final void mALPHA() throws RecognitionException {
		try {
			// TurtleOBDA.g:763:3: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C0' .. '\\u00D6' | '\\u00D8' .. '\\u00F6' | '\\u00F8' .. '\\u02FF' | '\\u0370' .. '\\u037D' | '\\u037F' .. '\\u1FFF' | '\\u200C' .. '\\u200D' | '\\u2070' .. '\\u218F' | '\\u2C00' .. '\\u2FEF' | '\\u3001' .. '\\uD7FF' | '\\uF900' .. '\\uFDCF' | '\\uFDF0' .. '\\uFFFD' )
			// TurtleOBDA.g:
			{
	...
	public final void mALPHANUM() throws RecognitionException {
		try {
			// TurtleOBDA.g:783:3: ( ALPHA | DIGIT )
			// TurtleOBDA.g:
			{
	...
	public final void mCHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:788:3: ( ALPHANUM | UNDERSCORE | MINUS | PERIOD )
			// TurtleOBDA.g:
			{
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			int _type = INTEGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:795:3: ( ( DIGIT )+ )
			// TurtleOBDA.g:795:5: ( DIGIT )+
			{
			// TurtleOBDA.g:795:5: ( DIGIT )+
			int cnt1=0;
			loop1:
	...
	public final void mDOUBLE() throws RecognitionException {
		try {
			int _type = DOUBLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:799:3: ( ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* )
			int alt12=3;
			alt12 = dfa12.predict(input);
			switch (alt12) {
				case 1 :
					// TurtleOBDA.g:799:5: ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					// TurtleOBDA.g:799:5: ( DIGIT )+
					int cnt2=0;
					loop2:
					while (true) {
						int alt2=2;
					...
					break;
				case 2 :
					// TurtleOBDA.g:800:5: PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					mPERIOD(); 

					// TurtleOBDA.g:800:12: ( DIGIT )+
					int cnt6=0;
					loop6:
					while (true) {
						int alt6=2;
					...
					break;
				case 3 :
					// TurtleOBDA.g:801:5: ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					// TurtleOBDA.g:801:5: ( DIGIT )+
					int cnt9=0;
					loop9:
					while (true) {
						int alt9=2;
	...
	public final void mDECIMAL() throws RecognitionException {
		try {
			int _type = DECIMAL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:805:3: ( ( DIGIT )+ PERIOD ( DIGIT )+ | PERIOD ( DIGIT )+ )
			int alt16=2;
			...
			switch (alt16) {
				case 1 :
					// TurtleOBDA.g:805:5: ( DIGIT )+ PERIOD ( DIGIT )+
					{
					// TurtleOBDA.g:805:5: ( DIGIT )+
					int cnt13=0;
					loop13:
					while (true) {
						int alt13=2;
					...
					break;
				case 2 :
					// TurtleOBDA.g:806:5: PERIOD ( DIGIT )+
					{
					mPERIOD(); 

					// TurtleOBDA.g:806:12: ( DIGIT )+
					int cnt15=0;
					loop15:
					while (true) {
						int alt15=2;
	...
	public final void mINTEGER_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:810:3: ( PLUS INTEGER )
			// TurtleOBDA.g:810:5: PLUS INTEGER
			{
			mPLUS(); 
	...
	public final void mINTEGER_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:814:3: ( MINUS INTEGER )
			// TurtleOBDA.g:814:5: MINUS INTEGER
			{
			mMINUS(); 
	...
	public final void mDOUBLE_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:818:3: ( PLUS DOUBLE )
			// TurtleOBDA.g:818:5: PLUS DOUBLE
			{
			mPLUS(); 
	...
	public final void mDOUBLE_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:822:3: ( MINUS DOUBLE )
			// TurtleOBDA.g:822:5: MINUS DOUBLE
			{
			mMINUS(); 
	...
	public final void mDECIMAL_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:826:3: ( PLUS DECIMAL )
			// TurtleOBDA.g:826:5: PLUS DECIMAL
			{
			mPLUS(); 
	...
	public final void mDECIMAL_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:830:3: ( MINUS DECIMAL )
			// TurtleOBDA.g:830:5: MINUS DECIMAL
			{
			mMINUS(); 
	...
	public final void mVARNAME() throws RecognitionException {
		try {
			int _type = VARNAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:834:3: ( ALPHA ( CHAR )* )
			// TurtleOBDA.g:834:5: ALPHA ( CHAR )*
			{
			mALPHA(); 

			// TurtleOBDA.g:834:11: ( CHAR )*
			loop17:
			while (true) {
				int alt17=2;
	...
	public final void mECHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:838:3: ( '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' ) )
			// TurtleOBDA.g:838:5: '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' )
			{
			match('\\'); 
	...
	public final void mSCHEMA() throws RecognitionException {
		try {
			// TurtleOBDA.g:841:16: ( ALPHA ( ALPHANUM | PLUS | MINUS | PERIOD )* )
			// TurtleOBDA.g:841:18: ALPHA ( ALPHANUM | PLUS | MINUS | PERIOD )*
			{
			mALPHA(); 

			// TurtleOBDA.g:841:24: ( ALPHANUM | PLUS | MINUS | PERIOD )*
			loop18:
			while (true) {
				int alt18=2;
	...
	public final void mURI_PATH() throws RecognitionException {
		try {
			// TurtleOBDA.g:843:18: ( ( ALPHANUM | UNDERSCORE | MINUS | COLON | PERIOD | HASH | QUESTION | SLASH ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID_START() throws RecognitionException {
		try {
			// TurtleOBDA.g:845:18: ( ( ALPHA | UNDERSCORE ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID_CORE() throws RecognitionException {
		try {
			// TurtleOBDA.g:847:17: ( ( ID_START | DIGIT ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID() throws RecognitionException {
		try {
			// TurtleOBDA.g:849:12: ( ID_START ( ID_CORE )* )
			// TurtleOBDA.g:849:14: ID_START ( ID_CORE )*
			{
			mID_START(); 

			// TurtleOBDA.g:849:23: ( ID_CORE )*
			loop19:
			while (true) {
				int alt19=2;
	...
	public final void mNAME_START_CHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:851:25: ( ( ALPHA | UNDERSCORE ) )
			// TurtleOBDA.g:
			{
			if ( (input.LA(1) >= 'A' && input.LA(1) <= 'Z')||input.LA(1)=='_'||(input.LA(1) >= 'a' && input.LA(1) <= 'z')||(input.LA(1) >= '\u00C0' && input.LA(1) <= '\u00D6')||(input.LA(1) >= '\u00D8' && input.LA(1) <= '\u00F6')||(input.LA(1) >= '\u00F8' && input.LA(1) <= '\u02FF')||(input.LA(1) >= '\u0370' && input.LA(1) <= '\u037D')||(input.LA(1) >= '\u037F' && input.LA(1) <= '\u1FFF')||(input.LA(1) >= '\u200C' && input.LA(1) <= '\u200D')||(input.LA(1) >= '\u2070' && input.LA(1) <= '\u218F')||(input.LA(1) >= '\u2C00' && input.LA(1) <= '\u2FEF')||(input.LA(1) >= '\u3001' && input.LA(1) <= '\uD7FF')||(input.LA(1) >= '\uF900' && input.LA(1) <= '\uFDCF')||(input.LA(1) >= '\uFDF0' && input.LA(1) <= '\uFFFD') ) {
				input.consume();
	...
	public final void mNAME_CHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:853:19: ( ( NAME_START_CHAR | DIGIT | UNDERSCORE | MINUS | PERIOD | HASH | QUESTION | SLASH | PERCENT | EQUALS | SEMI ) )
			// TurtleOBDA.g:
			{
	...
	public final void mNCNAME() throws RecognitionException {
		try {
			int _type = NCNAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:856:3: ( NAME_START_CHAR ( NAME_CHAR )* )
			// TurtleOBDA.g:856:5: NAME_START_CHAR ( NAME_CHAR )*
			{
			mNAME_START_CHAR(); 

			// TurtleOBDA.g:856:21: ( NAME_CHAR )*
			loop20:
			while (true) {
				int alt20=2;
	...
	public final void mNCNAME_EXT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:860:3: ( ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )* )
			// TurtleOBDA.g:860:5: ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )*
			{
			// TurtleOBDA.g:860:5: ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )*
			loop21:
			while (true) {
	...
	public final void mNAMESPACE() throws RecognitionException {
		try {
			int _type = NAMESPACE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:864:3: ( NAME_START_CHAR ( NAME_CHAR )* COLON )
			// TurtleOBDA.g:864:5: NAME_START_CHAR ( NAME_CHAR )* COLON
			{
			mNAME_START_CHAR(); 

			// TurtleOBDA.g:864:21: ( NAME_CHAR )*
			loop22:
			while (true) {
				int alt22=2;
	...
	public final void mPREFIXED_NAME() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:868:3: ( ( NCNAME )? COLON NCNAME_EXT )
			// TurtleOBDA.g:868:5: ( NCNAME )? COLON NCNAME_EXT
			{
			// TurtleOBDA.g:868:5: ( NCNAME )?
			int alt23=2;
	...
	public final void mSTRING_WITH_QUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:872:3: ( '\\'' ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\\'' )
			// TurtleOBDA.g:872:5: '\\'' ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\\''
			{
			match('\''); 
			// TurtleOBDA.g:872:10: ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop24:
			while (true) {
				int alt24=3;
	...
	public final void mSTRING_WITH_QUOTE_DOUBLE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:876:3: ( '\"' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\"' )
			// TurtleOBDA.g:876:5: '\"' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\"'
			{
			match('\"'); 
			// TurtleOBDA.g:876:10: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop25:
			while (true) {
				int alt25=3;
	...
	public final void mSTRING_WITH_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:880:3: ( '<' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '>' )
			// TurtleOBDA.g:880:5: '<' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '>'
			{
			match('<'); 
			// TurtleOBDA.g:880:9: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop26:
			while (true) {
				int alt26=3;
	...
	public final void mSTRING_WITH_CURLY_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:884:3: ( '{' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '}' )
			// TurtleOBDA.g:884:5: '{' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '}'
			{
			match('{'); 
			// TurtleOBDA.g:884:9: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop27:
			while (true) {
				int alt27=3;
	...
	public final void mSTRING_URI() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:888:3: ( SCHEMA COLON DOUBLE_SLASH ( URI_PATH )* )
			// TurtleOBDA.g:888:5: SCHEMA COLON DOUBLE_SLASH ( URI_PATH )*
			{
			mSCHEMA(); 
	...
	protected class DFA12 extends DFA {
		...
		public String getDescription() {
			return "798:1: DOUBLE : ( ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* );";
		}
	}
