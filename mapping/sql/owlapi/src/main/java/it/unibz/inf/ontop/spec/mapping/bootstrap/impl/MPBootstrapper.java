...
public class MPBootstrapper implements Bootstrapper {
    @Override
    public BootstrappingResults bootstrap(OntopMappingSQLOWLAPIConfiguration configuration, String baseIRI) throws MappingBootstrappingException, MappingException, OWLOntologyCreationException {
        return MPEngine.bootstrap(configuration, baseIRI);
    }
}
