...
public class OntopReasonerAbstractAction extends OntopAbstractAction {
    private final EditorKit editorKit;
    private final Function<OntopProtegeReasoner, OntopQuerySwingWorker<?, ?>> workerFactory;

    public OntopReasonerAbstractAction(String name, String icon, String tooltip, KeyStroke accelerator,
