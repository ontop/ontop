		...
		<html xml:lang="en" lang="en">
			...
			<body>
				...
				<div id="content">
                    ...
                    <!-- @xiao: now hidden by default. as this meesage appears and disappears immediately every time.
                        super annoying -->
					<p id="noscript-message" class="ERROR" style="visibility: hidden">
                        Scripting is not enabled. The
