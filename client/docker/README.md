...
**Additional Database Metadata and Constraints Definitions** *(endpoint, materialize, query, validate, bootstrap)*:
...
- **`ONTOP_ENABLE_ANNOTATIONS`** *(boolean flag, optional* - Enables annotation properties defined in the ontology. Corresponds to the argument `--enable-annotations`. Added in 5.0.0.
