...
//	
    ...
    if (oldSource != newSource) {
      if (oldSource != null) {
        HashSet<RDBMSDisjointnessDependency> list = 
            disjointnessDependencies.get(oldSource.getSourceID());
        Iterator<RDBMSDisjointnessDependency> it = list.iterator();
        while (it.hasNext()) {
          fireAssertionRemoved(it.next());
        }
      ...
      if (newSource != null) {
        HashSet<RDBMSDisjointnessDependency> list1 = 
            disjointnessDependencies.get(newSource.getSourceID());
