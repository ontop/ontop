...
public class RDBMSInclusionDependencyXMLCodec extends AssertionXMLCodec<RDBMSInclusionDependency> {
	 ...
	 * RDBMSInclusionDependency out of it.
	 */
	@Override
	...
	/**
	 * Given a RDBMSInclusionDependency, the method transforms it
	 * into XML
	 */
	@Override
	...
	/**
	 * Returns the list of Attributes used to describe a RDBMSInclusionDependency
	 * in XML
	 */
	...
	/**
	 * Returns the xml tag name of a RDBMSInclusionDependency
	 */
