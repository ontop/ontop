// $ANTLR 3.3 Nov 30, 2010 12:50:56 SQL99.g 2011-06-17 18:10:52
...
public class SQL99Lexer extends Lexer {
    ...
    public final void mSELECT() throws RecognitionException {
        try {
            ...
            // SQL99.g:167:7: ( ( 'S' | 's' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'T' | 't' ) )
            // SQL99.g:167:9: ( 'S' | 's' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'T' | 't' )
            {
    ...
    public final void mDISTINCT() throws RecognitionException {
        try {
            int _type = DISTINCT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:169:9: ( ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'T' | 't' ) )
            // SQL99.g:169:11: ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'T' | 't' )
            {
    ...
    public final void mALL() throws RecognitionException {
        try {
            int _type = ALL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:171:4: ( ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'L' | 'l' ) )
            // SQL99.g:171:6: ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'L' | 'l' )
            {
    ...
    public final void mFROM() throws RecognitionException {
        try {
            int _type = FROM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:173:5: ( ( 'F' | 'f' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'M' | 'm' ) )
            // SQL99.g:173:7: ( 'F' | 'f' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'M' | 'm' )
            {
    ...
    public final void mWHERE() throws RecognitionException {
        try {
            int _type = WHERE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:175:6: ( ( 'W' | 'w' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'E' | 'e' ) )
            // SQL99.g:175:8: ( 'W' | 'w' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'E' | 'e' )
            {
    ...
    public final void mAND() throws RecognitionException {
        try {
            int _type = AND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:177:4: ( ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'D' | 'd' ) )
            // SQL99.g:177:6: ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
    ...
    public final void mOR() throws RecognitionException {
        try {
            int _type = OR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:179:3: ( ( 'O' | 'o' ) ( 'R' | 'r' ) )
            // SQL99.g:179:5: ( 'O' | 'o' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
    ...
    public final void mNOT() throws RecognitionException {
        try {
            int _type = NOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:181:4: ( ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'T' | 't' ) )
            // SQL99.g:181:6: ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='N'||input.LA(1)=='n' ) {
                input.consume();
    ...
    public final void mORDER() throws RecognitionException {
        try {
            int _type = ORDER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:183:6: ( ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'R' | 'r' ) )
            // SQL99.g:183:8: ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
    ...
    public final void mBY() throws RecognitionException {
        try {
            int _type = BY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:185:3: ( ( 'B' | 'b' ) ( 'Y' | 'y' ) )
            // SQL99.g:185:5: ( 'B' | 'b' ) ( 'Y' | 'y' )
            {
    ...
    public final void mAS() throws RecognitionException {
        try {
            int _type = AS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:187:3: ( ( 'A' | 'a' ) ( 'S' | 's' ) )
            // SQL99.g:187:5: ( 'A' | 'a' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
    ...
    public final void mJOIN() throws RecognitionException {
        try {
            int _type = JOIN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:189:5: ( ( 'J' | 'j' ) ( 'O' | 'o' ) ( 'I' | 'i' ) ( 'N' | 'n' ) )
            // SQL99.g:189:7: ( 'J' | 'j' ) ( 'O' | 'o' ) ( 'I' | 'i' ) ( 'N' | 'n' )
            {
    ...
    public final void mON() throws RecognitionException {
        try {
            int _type = ON;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:191:3: ( ( 'O' | 'o' ) ( 'N' | 'n' ) )
            // SQL99.g:191:5: ( 'O' | 'o' ) ( 'N' | 'n' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
    ...
    public final void mLEFT() throws RecognitionException {
        try {
            int _type = LEFT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:193:5: ( ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'T' | 't' ) )
            // SQL99.g:193:7: ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
    ...
    public final void mRIGHT() throws RecognitionException {
        try {
            int _type = RIGHT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:195:6: ( ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'G' | 'g' ) ( 'H' | 'h' ) ( 'T' | 't' ) )
            // SQL99.g:195:8: ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'G' | 'g' ) ( 'H' | 'h' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
    ...
    public final void mIS() throws RecognitionException {
        try {
            int _type = IS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:197:3: ( ( 'I' | 'i' ) ( 'S' | 's' ) )
            // SQL99.g:197:5: ( 'I' | 'i' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
    ...
    public final void mNULL() throws RecognitionException {
        try {
            int _type = NULL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:199:5: ( ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'L' | 'l' ) ( 'L' | 'l' ) )
            // SQL99.g:199:7: ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'L' | 'l' ) ( 'L' | 'l' )
            {
            if ( input.LA(1)=='N'||input.LA(1)=='n' ) {
                input.consume();
    ...
    public final void mALPHA() throws RecognitionException {
        try {
            // SQL99.g:232:15: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // SQL99.g:232:17: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mALPHANUM() throws RecognitionException {
        try {
            // SQL99.g:236:18: ( ( ALPHA | DIGIT ) )
            // SQL99.g:236:20: ( ALPHA | DIGIT )
            {
    ...
    public final void mCHAR() throws RecognitionException {
        try {
            // SQL99.g:238:14: ( ( ALPHANUM | UNDERSCORE | DASH ) )
            // SQL99.g:238:16: ( ALPHANUM | UNDERSCORE | DASH )
            {
    ...
    public final void mSTRING_WITH_QUOTE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // SQL99.g:242:18: ( QUOTE_DOUBLE ( CHAR )* QUOTE_DOUBLE )
            // SQL99.g:242:20: QUOTE_DOUBLE ( CHAR )* QUOTE_DOUBLE
            {
            mQUOTE_DOUBLE(); 
            // SQL99.g:242:33: ( CHAR )*
            loop2:
    ...
    public void mTokens() throws RecognitionException {
        // SQL99.g:1:8: ( SELECT | DISTINCT | ALL | FROM | WHERE | AND | OR | NOT | ORDER | BY | AS | JOIN | ON | LEFT | RIGHT | IS | NULL | SEMI | DOT | COMMA | LSQ_BRACKET | RSQ_BRACKET | LPAREN | RPAREN | QUESTION | DOLLAR | QUOTE_DOUBLE | QUOTE_SINGLE | APOSTROPHE | UNDERSCORE | DASH | ASTERISK | AMPERSAND | AT | EXCLAMATION | HASH | PERCENT | PLUS | EQUALS | COLON | LESS | GREATER | SLASH | DOUBLE_SLASH | BACKSLASH | TILDE | CARET | STRING | STRING_WITH_QUOTE | WS )
        int alt5=50;
        ...
        switch (alt5) {
            ...
            case 48 :
                ...
                break;
            case 49 :
                // SQL99.g:1:339: STRING_WITH_QUOTE
                {
                mSTRING_WITH_QUOTE(); 
    ...
    static final String DFA5_eotS =
        "\15\52\11\uffff\1\74\2\uffff\1\76\1\77\13\uffff\1\101\5\uffff\4"+
        "\52\1\106\2\52\1\112\1\113\2\52\1\116\3\52\1\122\6\uffff\2\52\1"+
        "\125\1\126\1\uffff\3\52\2\uffff\1\132\1\52\1\uffff\3\52\1\uffff"+
        "\2\52\2\uffff\1\141\2\52\1\uffff\1\144\1\145\1\146\3\52\1\uffff"+
        "\1\152\1\153\3\uffff\1\154\1\155\1\52\4\uffff\1\52\1\160\1\uffff";
    static final String DFA5_eofS =
        "\161\uffff";
    static final String DFA5_minS =
        "\1\11\1\105\1\111\1\114\1\122\1\110\1\116\1\117\1\131\1\117\1\105"+
        "\1\111\1\123\11\uffff\1\42\2\uffff\2\55\13\uffff\1\57\5\uffff\1"+
        "\114\1\123\1\114\1\104\1\55\1\117\1\105\2\55\1\124\1\114\1\55\1"+
        "\111\1\106\1\107\1\55\6\uffff\1\105\1\124\2\55\1\uffff\1\115\1\122"+
        "\1\105\2\uffff\1\55\1\114\1\uffff\1\116\1\124\1\110\1\uffff\1\103"+
        "\1\111\2\uffff\1\55\1\105\1\122\1\uffff\3\55\2\124\1\116\1\uffff"+
        "\2\55\3\uffff\2\55\1\103\4\uffff\1\124\1\55\1\uffff";
    static final String DFA5_maxS =
        "\1\176\1\145\1\151\1\163\1\162\1\150\1\162\1\165\1\171\1\157\1\145"+
        "\1\151\1\163\11\uffff\1\172\2\uffff\2\172\13\uffff\1\57\5\uffff"+
        "\1\154\1\163\1\154\1\144\1\172\1\157\1\145\2\172\1\164\1\154\1\172"+
        "\1\151\1\146\1\147\1\172\6\uffff\1\145\1\164\2\172\1\uffff\1\155"+
        "\1\162\1\145\2\uffff\1\172\1\154\1\uffff\1\156\1\164\1\150\1\uffff"+
        "\1\143\1\151\2\uffff\1\172\1\145\1\162\1\uffff\3\172\2\164\1\156"+
        "\1\uffff\2\172\3\uffff\2\172\1\143\4\uffff\1\164\1\172\1\uffff";
    static final String DFA5_acceptS =
        "\15\uffff\1\22\1\23\1\24\1\25\1\26\1\27\1\30\1\31\1\32\1\uffff\1"+
        "\34\1\35\2\uffff\1\40\1\41\1\42\1\43\1\44\1\45\1\46\1\47\1\50\1"+
        "\51\1\52\1\uffff\1\55\1\56\1\57\1\60\1\62\20\uffff\1\33\1\61\1\36"+
        "\1\37\1\54\1\53\4\uffff\1\13\3\uffff\1\7\1\15\2\uffff\1\12\3\uffff"+
        "\1\20\2\uffff\1\3\1\6\3\uffff\1\10\6\uffff\1\4\2\uffff\1\21\1\14"+
        "\1\16\3\uffff\1\5\1\11\1\17\1\1\2\uffff\1\2";
    static final String DFA5_specialS =
        "\161\uffff}>";
    static final String[] DFA5_transitionS = {
            "\2\53\2\uffff\1\53\22\uffff\1\53\1\36\1\26\1\37\1\25\1\40\1"+
            "\34\1\27\1\22\1\23\1\33\1\41\1\17\1\32\1\16\1\46\12\uffff\1"+
            "\43\1\15\1\44\1\42\1\45\1\24\1\35\1\3\1\10\1\uffff\1\2\1\uffff"+
            ...
            "\1\54\37\uffff\1\54",
            "\1\55\37\uffff\1\55",
            "\1\56\1\uffff\1\57\4\uffff\1\60\30\uffff\1\56\1\uffff\1\57"+
            "\4\uffff\1\60",
            "\1\61\37\uffff\1\61",
            "\1\62\37\uffff\1\62",
            ...
            "",
            "",
            "\1\75\12\uffff\1\75\2\uffff\12\75\7\uffff\32\75\4\uffff\1\75"+
            "\1\uffff\32\75",
            "",
            "",
            ...
            "\1\107\37\uffff\1\107",
            "\1\110\37\uffff\1\110",
            "\1\52\2\uffff\12\52\7\uffff\3\52\1\111\26\52\4\uffff\1\52\1"+
            "\uffff\3\52\1\111\26\52",
            "\1\52\2\uffff\12\52\7\uffff\32\52\4\uffff\1\52\1\uffff\32\52",
            "\1\114\37\uffff\1\114",
            "\1\115\37\uffff\1\115",
