...
public class MappingAnalyzerTest extends TestCase {
	...
	public void testBooks() throws Exception {
		...
		DBMetadata metadata = JDBCConnectionManager.getJDBCConnectionManager().getMetaData(sourceId);
	...
	private void setup(String inputFile) throws Exception {
		...
		JDBCConnectionManager.getJDBCConnectionManager().setupConnection(obdaModel); // new call
	}
}
