...
public boolean validate(CQIE targetQuery) {
    ...
    while(iterAtom.hasNext()) {
      ...
      boolean isClass = ontology.containsClassInSignature(IRI.create(predicateUri));      
      boolean isObjectProp = ontology.containsObjectPropertyInSignature(IRI.create(predicateUri));
      boolean isDataProp = ontology.containsDataPropertyInSignature(IRI.create(predicateUri));
