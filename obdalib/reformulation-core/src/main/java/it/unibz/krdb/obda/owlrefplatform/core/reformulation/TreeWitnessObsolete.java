...
public class TreeWitnessObsolete {
	...
	public TreeWitnessObsolete(Term term, PredicatePosition direction) 	{
		this.term = term;
	...
	public boolean equals(Object obj) {
		if ((obj == null) || !(obj instanceof TreeWitnessObsolete))
			return false;
		
		TreeWitnessObsolete tw = (TreeWitnessObsolete)obj;
