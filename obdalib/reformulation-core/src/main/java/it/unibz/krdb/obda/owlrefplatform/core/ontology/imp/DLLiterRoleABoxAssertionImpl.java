...
public class DLLiterRoleABoxAssertionImpl implements RoleABoxAssertion {

	private Predicate	role;
	private URIConstant	o2;
	private URIConstant	o1;

	public DLLiterRoleABoxAssertionImpl(Predicate role, URIConstant o1, URIConstant o2) {
		this.role = role;
		this.o1 = o1;
		this.o2 = o2;
	}
