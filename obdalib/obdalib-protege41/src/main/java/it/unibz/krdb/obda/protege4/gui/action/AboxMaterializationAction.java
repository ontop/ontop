...
import it.unibz.krdb.obda.owlrefplatform.owlapi3.OWLAPI3IndividualIterator;
...
public class AboxMaterializationAction extends ProtegeAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (response == JOptionPane.YES_OPTION) {			
			try {
				...
				OWLAPI3IndividualIterator individuals = new OWLAPI3IndividualIterator(obdaModel);
	...
	private class MaterializeAction implements OBDAProgressListener {
		...
		private OWLAPI3IndividualIterator iterator = null;
		
		private boolean bCancel = false;

		public MaterializeAction(OWLModelManager modelManager, OWLAPI3IndividualIterator iterator) {
