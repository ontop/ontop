...
CREATE TABLE address (
	...
	CONSTRAINT address_pkey PRIMARY KEY NONCLUSTERED (id)
);
...
CREATE TABLE broker (
    ...
    addressid integer
	CONSTRAINT broker_pkey PRIMARY KEY NONCLUSTERED (id)
);
...
CREATE TABLE client (
    ...
    ssn character varying(100),
    addressid integer
	CONSTRAINT client_pkey PRIMARY KEY NONCLUSTERED (id)
);
...
CREATE TABLE company (
    ...
    addressid integer
	CONSTRAINT company_pkey PRIMARY KEY NONCLUSTERED (id)
);

CREATE TABLE stockbooklist (
    date date NOT NULL,
    stockid integer
	CONSTRAINT stockbooklist_pkey PRIMARY KEY NONCLUSTERED (date)
);
