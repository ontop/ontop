 ...
 */
public class DLLiteCompletenessTest_Setting4 extends CompletenessTest {

	public DLLiteCompletenessTest_Setting4(String tid, String name, String resf,
	...
	public static Test suite() throws Exception {
		return CompletenessTestUtils.suite(new Factory() {
			...
			public CompletenessTest createCompletenessTest(String testId,
				...
				return new DLLiteCompletenessTest_Setting4(testId, testName,
