...
public class QuestManifestTest {

	static final Logger logger = LoggerFactory.getLogger(QuestManifestTest.class);
	...
	public static TestSuite suite(SPARQLQueryTest.Factory factory) throws Exception
	{
		...
		URL url = QuestManifestTest.class.getResource("/testcases-dawg-quest/data-r2/manifest-evaluation.ttl");
