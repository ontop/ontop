 ...
 *
 */
public class OraclePrefixSourceTest {
    ...
    final String obdaFile = "src/test/resources/stockexchangePrefix.obda";
...
//        p.setCurrentValueOf(QuestPreferences.SQL_GENERATE_REPLACE, QuestConstants.FALSE);
        ...
        assertEquals("<http://example.com/resource/?repository=repo&uri=http://www.owl-ontologies.com/Ontology1207768242.owl/Address-991>", results);
    }
