...
//		TEST preference.setCurrentValueOf(QuestPreferences.T_MAPPINGS, QuestConstants.FALSE); // Disable T_Mappings
        ...
        queries[5]=	        "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A5. ?x :R ?y. ?y a  :A5}  ";
        queries[6]=	        "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A4. ?x :R ?y. ?y a  :A5}  ";
        queries[7]=	        "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A3. ?x :R ?y. ?y a  :A5}  ";
        queries[8]=	        "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A2. ?x :R ?y. ?y a  :A5}  ";
        queries[9]=	        "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A1. ?x :R ?y. ?y a  :A5}  ";

        queries[10]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A4. ?x :R ?y. ?y a  :A4}  ";
        queries[11]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A3. ?x :R ?y. ?y a  :A4}  ";
        queries[12]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A2. ?x :R ?y. ?y a  :A4}  ";
        queries[13]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A1. ?x :R ?y. ?y a  :A4}  ";

        queries[14]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A3. ?x :R ?y. ?y a  :A3}  ";
        queries[15]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A2. ?x :R ?y. ?y a  :A3}  ";
        queries[16]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A1. ?x :R ?y. ?y a  :A3}  ";

        queries[17]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A2. ?x :R ?y. ?y a  :A2}  ";
        queries[18]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A1. ?x :R ?y. ?y a  :A2}  ";

        queries[19]=	    "PREFIX : <http://www.example.org/> SELECT ?x   WHERE {?x a  :A1. ?x :R ?y. ?y a  :A1}  ";
