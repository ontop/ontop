package it.unibz.inf.ontop.tests.docker;
...
public class DockerMysqlTestsuite extends QuestVirtualScenarioParent {
	...
	public DockerMysqlTestsuite(String testURI, String name, String queryFileURL, String resultFileURL, 
	...
	public static Test suite() throws Exception {
		return ScenarioManifestTestUtils.suite(new Factory() {
			...
			public QuestVirtualScenarioParent createQuestScenarioTest(String testURI, String name, String queryFileURL, 
				...
				return new DockerMysqlTestsuite(testURI, name, queryFileURL, resultFileURL, owlFileURL, 
						obdaFileURL, "");
			}
			@Override
			public QuestVirtualScenarioParent createQuestScenarioTest(String testURI, String name, String queryFileURL, 
