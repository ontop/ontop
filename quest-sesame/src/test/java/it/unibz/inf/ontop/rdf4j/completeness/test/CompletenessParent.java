package it.unibz.inf.ontop.rdf4j.completeness.test;
...
import it.unibz.inf.ontop.rdf4j.repository.OntopClassicRepository;
...
public abstract class CompletenessParent extends TestCase {
	...
	protected Repository createRepository() throws Exception {
		QuestConfiguration configuration = QuestConfiguration.defaultBuilder()
				...
				.build();
		OntopClassicRepository repository = new OntopClassicRepository("CompletenessTest", configuration);
