...
public class OntopClassicInMemoryRepository extends OntopClassicRepository {

	public OntopClassicInMemoryRepository(String name, String tboxFile, boolean existential, String rewriting) throws Exception {
	...
	public OntopClassicInMemoryRepository(String name, Dataset data) throws Exception {
